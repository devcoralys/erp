...
if($_SESSION['is_resp']==1){ header('Location: accueil_approbation.php'); }
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="sauvegarder.php" id="topnav-dashboard">
                                            <i class="icon nav-icon uil uil-money-withdrawal"></i>
                                            <span data-key="t-dashboards">Reportées</span> 
                                        </a>
                                    </li>
...
<!--
        ...
        <div class="main-content">
            <div class="page-content">
			    ...
			    <select <?php if($_SESSION['resp_logistique']==1 || $_SESSION['resp_technique']==1 || $_SESSION['resp_bureau']==1 || $_SESSION['resp_rh']==1){ echo ' disabled ';  } ?> class="form-control" data-trigger id="recher_affectation" name="recher_affectation" >
           ...
           {
           ?>
           <option value="<?php echo''.$ro['id_affectation'].''; ?>" <?php if($_SESSION['resp_rh']==1 && $ro['id_affectation']==28){ echo ' selected';  } if($_SESSION['resp_logistique']==1 && $ro['id_affectation']==20){ echo ' selected';  } if($_SESSION['resp_technique']==1 && $ro['id_affectation']==1){ echo ' selected';  } if($_SESSION['resp_bureau']==1 && ($ro['id_affectation']==18 || $ro['id_affectation']==19) ){ echo ' selected';  }  ?> ><?php echo''.stripslashes($ro['lib_affectation']).'' ; ?></option>
           <?php
           }
           ?>
			    </select>
