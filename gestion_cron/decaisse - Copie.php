                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="accepte.php" id="topnav-dashboard">
                                            ...
                                            <span data-key="t-dashboards">Demandes acceptées</span> 
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="refuse.php" id="topnav-dashboard">
                                            ...
                                            <span data-key="t-dashboards">Demandes réfusées</span> 
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="decaisse.php" id="topnav-dashboard">
                                            ...
                                            <span data-key="t-dashboards">Demandes décaissées</span> 
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="sauvegarder.php" id="topnav-dashboard">
                                            <i class="icon nav-icon uil uil-money-withdrawal"></i>
                                            <span data-key="t-dashboards">Demandes sauvegardées</span> 
                                        </a>
                                    </li>
...
<!--
        ...
        <div class="row">
            <a href="exportation/pdf/pdf_liste_decaisse.php" target="_blank" title="exporter en pdf"><img src="img/export_pdf.png" style="width:25px;" class="img-responsive"> Exportation demandes décaissées</a>
        </div>
