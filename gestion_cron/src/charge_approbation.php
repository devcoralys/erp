<?php
  ...
  <?php 
    ...
    $_SESSION["recher_affectation"]=$recher_affectation;
	 ...
	 $requete="SELECT * FROM fiche WHERE id_fiche!=''AND etat_fiche=0 AND decaisse=0 AND sauvegarder=0 AND approuve=0 ";
