...
<!--
        ...
        <div class="main-content">
            <div class="page-content">
			    ...
			    <select disabled <?php if($_SESSION['resp_logistique']==1 || $_SESSION['resp_technique']==1 || $_SESSION['resp_bureau']==1 || $_SESSION['resp_rh']==1){ echo ' disabled ';  } ?> class="form-control" data-trigger id="recher_affectation" name="recher_affectation" >
