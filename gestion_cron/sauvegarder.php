...
<html lang="en" id="all_page">
    ...
    <head>
        ...
        <meta charset="utf-8" />
         <title><?php include('titre_ent_1.php'); ?>  | Demandes sauvegardées</title>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="sauvegarder.php" id="topnav-dashboard" style="background-color:#fabd02; color:#22254b;">
                                            <i class="icon nav-icon uil uil-money-withdrawal"></i>
                                            <span data-key="t-dashboards">sauvegardées</span> 
                                        </a>
                                    </li>
...
<!--
                                            ...
                                            <div class="mb-3">
                                                <h5 class="card-title">Liste des demandes 
                                                    <span class="text-muted fw-normal ms-2">
                                                        (
                                                            <?php
                                                $nf=$con->prepare('SELECT * FROM fiche WHERE etat_fiche=0 AND decaisse=0 AND sauvegarder=1 ORDER BY id_fiche ASC ');
                                                $nf->execute();
                                                $qnf=$nf->rowcount();
                                                echo $qnf;
                                                            ?>
        ...
        $rep=$con->prepare('SELECT * FROM fiche WHERE etat_fiche=0 AND decaisse=0 AND sauvegarder=1 ORDER BY id_fiche ASC ');
        $rep->execute();
            ...
            echo '
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            ...
                                            <div class="card border shadow-none">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        <div class="flex-shrink-0 avatar rounded-circle me-4">
                                                            <img style="height:100px; width:100px;" src="../../img_demande/'; if($repo['photo_beneficiaire']!=''){echo $repo['photo_beneficiaire'];}else{ echo 'default_picture.png';} echo '" alt="" class="img-fluid rounded-circle">
                                                        </div>
                                                ...
                                                echo '
                                                    <a href="src/valider_fiche.php?num_fiche_valide='.$repo['num_fiche'].'" class="btn btn-success"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Profile"><i class="uil uil-check"></i></button></a>
                                                    <a href="src/sauvegarder_fiche.php?num_fiche_sauvegarder='.$repo['num_fiche'].'" class="btn btn-primary"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Message"><i class="uil uil-save"></i></button></a>
                                                    <a href="detail_refus.php?num_fiche_refuse='.$repo['num_fiche'].'" class="btn btn-danger"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Projects"><i class="uil uil-trash"></i></button></a>
                                                ';
                                                }
                                                if($_SESSION['is_modif']==1){
                                                echo '    
                                                    <a target="_blank" href="modifier_fiche.php?num_fiche='.$repo['num_fiche'].'" class="btn btn-warning"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Profile"><i class="uil uil-edit"></i></button></a>
                                                ';
                                                }
                                                echo '
                                                </div>
...
'
            <tr>
                <td>
                    <img src="../../img_demande/'; if($repo['photo_beneficiaire']!=''){echo $repo['photo_beneficiaire'];}else{ echo 'default_picture.png';} echo '" class="avatar-lg img-thumbnail h-auto rounded-circle" alt="Error">
                </td>
                <td>
                    '.$repo['num_fiche'].'
                </td>
            ...
            echo    '.number_format($repo['montant_fiche'],0,',',' ').' FCFA
                </td>
                <td>
                ...
                if($_SESSION['is_valid']==1){
                    echo '
                    <a href="src/valider_fiche.php?num_fiche_valide='.$repo['num_fiche'].'" class="btn btn-success"><i class="fa fa-check"></i> Accepter</a>
                    &nbsp;&nbsp;
                    <a href="detail_refus.php?num_fiche_refuse='.$repo['num_fiche'].'" class="btn btn-danger"><i class="fa fa-ban"></i> Réfuser</a>
                    &nbsp;&nbsp;
                    ';
                }
                    ...
                    if($_SESSION['is_modif']==1){
                    echo '
                    <a target="_blank" href="modifier_fiche.php?num_fiche='.$repo['num_fiche'].'" class="btn btn-warning"><i class="fa fa-pencil"></i> Modifier</a>';
                    }
                    echo '
                </td>
            </tr>
