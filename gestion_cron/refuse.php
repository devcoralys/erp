                        ...
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="refuse.php" id="topnav-dashboard" style="background-color:#fabd02; color:#22254b;">
...
<!--
		...
		<!--<div class="col-lg-2" style="margin-top:10px; text-align:center;"><button type="submit" id="envoie_recher_pers" class="btn btn-warning envoie_recher_pers"><i class="fa fa-search"></i> Rechercher</button></div>-->
                ...
                <div class="row">
                                            ...
                                            <div class="mb-3">
                                                <h5 class="card-title">Liste des demandes 
                                                    <span class="text-muted fw-normal ms-2">
                                                        (
                                                            <?php
                                                $nf=$con->prepare('SELECT * FROM fiche WHERE etat_fiche=2 AND decaisse=0 AND sauvegarder=0 ORDER BY id_fiche ASC ');
                                                $nf->execute();
                                                $qnf=$nf->rowcount();
                                                echo $qnf;
                                                            ?>
                        ...
                        $rep=$con->prepare('SELECT * FROM fiche WHERE etat_fiche=2 AND decaisse=0 AND sauvegarder=0 ORDER BY id_fiche ASC ');
                        $rep->execute();
