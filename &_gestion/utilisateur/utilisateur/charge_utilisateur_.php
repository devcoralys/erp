<?php
  ...
  var dataString = 'page_id_cons='+ page_id_cons+"&recher_utilisateur="+recher_utilisateur+"&recher_service="+recher_service+"&recher_statut="+recher_statut+"&recher_groupe="+recher_groupe;
    ...
    $requete=" SELECT * FROM utilisateur LEFT JOIN personnel ON personnel.id_personnel=utilisateur.personnel_id INNER JOIN service ON service.id_service=personnel.service_id  INNER JOIN fonction ON fonction.id_fonction=personnel.fonction_id WHERE id_utilisateur!='' ";
    ...
    $requete.=" AND (nom_personnel LIKE '%".$recher_utilisateur."%' || email_personnel LIKE '%".$recher_utilisateur."%' || tel_personnel LIKE '%".$recher_utilisateur."%') ";
    }        
    ...
    if($recher_utilisateur!="" || $recher_groupe!="" || $recher_service!="" || $recher_statut!="" ){
    $req=" SELECT * FROM utilisateur LEFT JOIN personnel ON personnel.id_personnel=utilisateur.personnel_id INNER JOIN service ON service.id_service=personnel.service_id  INNER JOIN fonction ON fonction.id_fonction=personnel.fonction_id WHERE id_utilisateur!='' ";
    ...
    if($recher_utilisateur!=""){		 
    $req.=" AND (nom_personnel LIKE '%".$recher_utilisateur."%' || email_personnel LIKE '%".$recher_utilisateur."%' || tel_personnel LIKE '%".$recher_utilisateur."%') ";
    }        
...
$req.=" ORDER BY nom_personnel ASC LIMIT $start, $records_per_page ";
