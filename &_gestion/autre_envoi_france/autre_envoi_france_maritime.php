            ...
            <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="../autre_envoi_france/autre_envoi_france.php" style="background-color:#251f75; color:#fff;" data-key="t-p-list"> Colis Maritime</a></li>
                            </ul>
                        </li>
                        <?php } ?>
    ...
    <div class="modal-content">
	  ...
	  <form name="form_autre_envoi_france" id="form_autre_envoi_france" class="form-horizontal" action="#">
		...
		<select required class="form-control" id="mode_envoi" style="background-color:#f9f9f9; height:45px;">
	                <option value="MARITIME"><img src="../img/ba.png" /> Maritime</option>
            	</select>
        </div>	
