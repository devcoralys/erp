        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a a href="../autre_envoi_france/autre_envoi_france.php" style="background-color:#251f75; color:#fff;" data-key="t-p-grid"> Colis accompagnés</a></li>
                                <li><a href="../autre_envoi_france/autre_envoi_france_dhl.php" data-key="t-p-list"> Colis DHL</a></li>
                                <li><a href="../autre_envoi_france/autre_envoi_france_fret.php" data-key="t-p-list"> Colis Fret</a></li>
                                <li><a href="../autre_envoi_france/autre_envoi_france_maritime.php" data-key="t-p-list"> Colis Maritime</a></li>
                            </ul>
                        </li>
                        <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_autre_envoi_france" data-toggle="modal" data-target="#myModal_autre_envoi_france" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Nouvel envoi extérieur</button>
                        ...
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    ...
                                    <input type="text" class="form-control" name="recher_code_colis_autre_envoi_france" id="recher_code_colis_autre_envoi_france" placeholder="Code colis">
					            </div>
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_autre_envoi_france">
...
<!-- Modal caisse -->
<!-- Modal -->
<div class="modal fade" id="myModal_autre_envoi_france" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    <div style="ckground-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_autre_envoi_france" id="form_autre_envoi_france" class="form-horizontal" action="#">
         ...
         <div class="col-lg-4 col-xs-12">
				 ...
				 <input readonly style="background-color:#f9f9f9; height:45px;" type="date" class="form-control" required id="date_autre_envoi_france" name="date_autre_envoi_france" value="<?php echo gmdate('Y-m-d'); ?>"  />
        </div>	
		...
		<select required class="form-control" id="mode_envoi" style="background-color:#f9f9f9; height:45px;">
		                <option value="BA"><img src="../img/ba.png" /> Colis Accompagné</option>
            	</select>
        </div>	
        ...
        <div class="col-lg-4 col-xs-12">
			...
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="expediteur_autre_envoi_france" name="expediteur_autre_envoi_france" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>N° CNI Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="num_cni_expediteur_autre_envoi_france" name="num_cni_expediteur_autre_envoi_france" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_expediteur_autre_envoi_france" name="tel_expediteur_autre_envoi_france" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destinataire [Nom et Prénom(s)]<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destinataire_autre_envoi_france" name="destinataire_autre_envoi_france" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destination<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destination_autre_envoi_france" name="destination_autre_envoi_france" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Destinataire<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_destinataire_autre_envoi_france" name="tel_destinataire_autre_envoi_france" value="" />
        </div>	
        ...
        <div class="col-lg-12 col-xs-12">
				 ...
				 <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="adresse_recuperation_autre_envoi_france" name="adresse_recuperation_autre_envoi_france" value=""  />
            </div>		
		</div>
        <div class="row">
            <div class="col-lg-8 col-xs-12">
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="button" id="envoie_autre_envoi_france" class="btn button_valid"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
