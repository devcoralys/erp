            ...
            <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="../autre_envoi_france/autre_envoi_france_fret.php" style="background-color:#251f75; color:#fff;" data-key="t-p-list"> Colis Fret</a></li>
    ...
    <div class="modal-content">
	  ...
	  <form name="form_autre_envoi_france" id="form_autre_envoi_france" class="form-horizontal" action="#">
		...
		<select required class="form-control" id="mode_envoi" style="background-color:#f9f9f9; height:45px;">
	                <option value="FRET"><img src="../img/dhl.png" /> CARGO</option>
	                	                <option value="EXPRESS"><img src="../img/dhl.png" /> EXPRESS</option>
