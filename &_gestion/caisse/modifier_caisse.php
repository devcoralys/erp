...
include('../../connex.php');
    ...
    $id_caisse_mod=$_GET['id_dec_mod'];
    
    $_SESSION['id_dec_mod']=$id_caisse_mod;
    
    $enc=$con->prepare('SELECT * FROM caisse WHERE id_caisse=:A');
    $enc->execute(array('A'=>$id_caisse_mod));

    $inf_enc=$enc->fetch();

    $date_caisse=$inf_enc["date_caisse"];
    $montant_caisse=floatval($inf_enc["montant_caisse"]);
    $mode_reglement_caisse=$inf_enc["mode_reglement_caisse"];
    $motif_caisse=$inf_enc["motif_caisse"];
    ...
    <a href="excel/excel_declaration.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_caisse_modifier">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_caisse" name="date_caisse" value="<?php echo $inf_enc["date_caisse"]; ?>" />
            </div>		
		...
		<div class="row">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="nom_client_caisse" name="nom_client_caisse" placeholder="nom_client" value="<?php echo $inf_enc["nom_client_caisse"]; ?>" >
                            <label for="floatingInput">Demandeur</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input  type="number" class="form-control" id="montant_caisse" name="montant_caisse" placeholder="montant" value="<?php echo floatval($inf_enc["montant_caisse"]); ?>" >
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="submit" id="envoie_caisse_mod" class="btn button_valid"><i class="fa fa-check"></i> Enregistrer les modifications</button>&nbsp;&nbsp;
