...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | caisse</title>
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
           ...
           <?php if($_SESSION['acces_demande_decaissement']==1 ){ ?>
            ...
            <li>
                <a href="../caisse/caisse.php" style="background-color:#251f75; color:#fff;">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_caisse" data-toggle="modal" data-target="#myModal_caisse" style="margin:10px; " class="btn btn-info"><i class="fa fa-">+</i> Nouvel enregistrement</button>
                            </div>
                        ...
                        <div class="card-body_" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    <label class="col-lg-4 control-label"><b>Donneur</b></label>
                                    <input type="text" class="form-control" name="recher_demandeur" id="recher_demandeur" placeholder="Demandeur">
					            </div>
...
<!-- Modal caisse -->
<!-- Modal -->
<div class="modal fade" id="myModal_caisse" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus_">+</i> Nouvel enregistrement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_caisse" id="form_caisse" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_caisse" name="date_caisse" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-8 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_caisse" name="nom_client_caisse" />
            </div>		
            
            <div class="col-lg-4 col-xs-12">
                <label>Montant<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_caisse" name="montant_caisse" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-8 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_caisse_" name="nom_client_caisse_" />
            </div>		
            
            <div class="col-lg-4 col-xs-12">
                <label>N° RECU<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_caisse_" name="montant_caisse_" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_caisse" name="motif_caisse"></textarea>
            </div>		
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification caisse</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression caisse</h4>
      </div>
      <div class="modal-body">
