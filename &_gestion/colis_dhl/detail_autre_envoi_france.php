...
$_SESSION['id_colis_dhl']=$_GET['id_colis_dhl'];
...
$inf1=$con->prepare('SELECT * FROM colis_dhl WHERE id_colis_dhl=:A');
$inf1->execute(array('A'=>$_SESSION['id_colis_dhl']));
$info1=$inf1->fetch();

$lib_trace="Ouverture autre envoi N* <b>".$info1['num_colis_dhl']."</b> ";
...
$inf->execute(array('A'=>$_SESSION['id_colis_dhl']));
$info=$inf->fetch();

$num_colis_dhl=$info['num_colis_dhl'];
$date_colis_dhl=date("d/m/Y", strtotime($info['date_colis_dhl']));
$expediteur_colis_dhl=stripslashes($info['expediteur_colis_dhl']);
$num_cni_expediteur_colis_dhl=stripslashes($info['num_cni_expediteur_colis_dhl']);
$tel_expediteur_colis_dhl=stripslashes($info['tel_expediteur_colis_dhl']);
$code_colis_colis_dhl=stripslashes($info['code_colis_colis_dhl']);
$destinataire_colis_dhl=stripslashes($info['destinataire_colis_dhl']);
$destination_colis_dhl=stripslashes($info['destination_colis_dhl']);
$tel_destinataire_colis_dhl=stripslashes($info['tel_destinataire_colis_dhl']);
$etat_colis_dhl=$info['etat_colis_dhl'];
$time_colis_dhl=$info['time_colis_dhl'];
$valeur_colis_colis_dhl=$info['valeur_colis_colis_dhl'];
$montant_assurance=$info['montant_assurance'];

$_SESSION['time']=$time_colis_dhl;
?>
<!doctype html>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | colis_dhl</title>
...
<div data-simplebar class="sidebar-menu-scroll">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <?php if($_SESSION['acces_colis_dhl']==1 ){ ?>
            <li>
                <a href="../colis_dhl/colis_dhl.php" style="background-color:#251f75; color:#fff;">
...
<!-- Left Sidebar End -->
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="chargement_" style="text-align:center; margin-top:70px"></div>
                          ...
                          $bes=$con->prepare('SELECT * FROM colis_dhl WHERE id_colis_dhl=:A');
                          $bes->execute(array('A'=>$_SESSION['id_colis_dhl']));
                          $ibes=$bes->fetch();

                       
                          $etat_colis_dhl = $ibes['etat_colis_dhl'];
					    ...
					    <div class="col-lg-12">
					        <div class="panel">
					            <div class="panel-heading" style="background-color:#a44b73; background-color:#f7f8fa;">
					                <h3 class="panel-title"  style="text-align:center; color:#3e58ff;">LISTE DE COLISAGE <b>N° <?php echo $num_colis_dhl; ?></b></h3><br>
                                    <p style="text-align:center; color:#3e58ff;">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <b>Date : <?php echo $date_colis_dhl; ?> </b><br>
                                                <b>Expéditeur : </b><label><?php echo $expediteur_colis_dhl; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>N° CNI : </b><label><?php echo $num_cni_expediteur_colis_dhl; ?></label><br>
                                                <b>Téléphone Expéditeur : </b><label><?php echo $tel_expediteur_colis_dhl; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>Code Colis : <?php echo $code_colis_colis_dhl; ?> </b><br>
                                                <b>Destinataire : </b><label><?php echo $destinataire_colis_dhl; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>Destination : </b><label><?php echo $destination_colis_dhl; ?></label><br>
                                                <b>Téléphone Destinataire : </b><label><?php echo $tel_destinataire_colis_dhl; ?></label><br>
                                            </div>
                                        </div>
                                    </p>
					            </div>
        ...
        <?php if($etat_colis_dhl==0){ ?>
        <button id="terminer" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Terminer</button>
        <button id="ajout_colis_colis_dhl" data-toggle="modal" data-target="#myModal_colis_colis_dhl" style="margin:10px; right:10px; position:absolute; margin-bottom:10px;" class="btn btn-purple right"><i class="fa fa-plus"></i> Ajouter une ligne</button>
        ...
        <p style="border-bottom:1px solid #E3E3E3">&nbsp;&nbsp;</p>
                ...
                <?php if($etat_colis_dhl>=1){ ?>
                <a href="../exportation/pdf/pdf_colis_dhl.php?id_colis_dhl=<?php echo $_SESSION['id_colis_dhl']; ?>" target="_blank" style="font-size:28px; font-weight:600; color: black;" title="Cliquez pour générer la fiche">
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_colis_colis_dhl">
...
<!-- Modal colis_colis_dhl -->
<!-- Modal -->
<div class="modal fade" id="myModal_colis_colis_dhl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_colis_colis_dhl" id="form_colis_colis_dhl" class="form-horizontal" action="#">
		
		<div class="row">
        
            <div class="col-lg-3 col-xs-12">
                <label>Nbre Colis<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="nbre_colis_colis_dhl" name="nbre_colis_colis_dhl" placeholder="Nombre Colis" />
                <input style="background-color:#f9f9f9; height:45px;" type="hidden" class="form-control" required value="<?php echo $time_colis_dhl; ?>" id="time_colis_dhl" />
            </div>	
            <div class="col-lg-3 col-xs-12">
            ...
            <div class="col-lg-6 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="nature_colis_colis_dhl" name="nature_colis_colis_dhl" placeholder="Nature du colis"  />
            </div>
            <div class="col-lg-4 col-xs-12">
                <label>Poids<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="poids_colis_colis_dhl" name="poids_colis_colis_dhl" placeholder="Poids"  />
            </div>
            <div class="col-lg-4 col-xs-12">
                <label>Prix / Kilo<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="pu_colis_colis_dhl" name="pu_colis_colis_dhl" placeholder="Prix/Kg"  />
            </div>	
            <div class="col-lg-4 col-xs-12">
                <label>Emballage<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="emballage_colis_colis_dhl" name="emballage_colis_colis_dhl" placeholder="Coût de l'emballage"  />
            </div>	
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix du colis : <span class="semi_aste" id="prix_total_colis_colis_dhl" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-3 col-xs-12">
                   &nbsp;
                </div>  
        ...
        <div class="col-lg-12 col-xs-12 msg_error"></div>
		 ...
		 <button type="submit" id="envoie_colis_colis_dhl" class="btn"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
		...
		<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="valeur_colis_colis_dhl" name="valeur_colis_colis_dhl" placeholder="Saisir le prix total de cet envoi"  />
                </div>	
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix de la marchandise : <span class="semi_aste" id="prix_final_colis_colis_dhl" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-6 col-xs-12">
...
<div class="modal fade mod_pop" id="myModal_colis_colis_dhl_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification colis_colis_dhl</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_colis_colis_dhl_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_colis_colis_dhl_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_colis_colis_dhl_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_colis_colis_dhl_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_terminer">Voulez-vous vraiment clôturer la saisie de ce colis_dhl ?</div>
		</div>
