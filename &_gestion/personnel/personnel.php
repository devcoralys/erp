...
<div data-simplebar class="sidebar-menu-scroll">
    ...
    <div id="sidebar-menu">
     ...
     <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
            ...
            <li>
                <a href="../personnel/personnel.php" class="active" style="background-color:#251f75; color:#fff;">
...
<!-- Left Sidebar End -->
        ...
        <div class="main-content">
            <div class="page-content">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-lg-4 toolbar-right">
                                    <div class="row">
                                        ...
                                        <button style="margin:3px;" class="btn btn-purple add_pers" data-toggle="modal" data-target="#modal_pers"><i class="fa fa-plus"></i> Ajouter une personne</button>
                                        <button style="margin:3px;" class="btn btn-success import_pers"><i class="fa fa-download"></i> Importer la liste du personnel</button>
                                        </div>
              ...
              <option value="">Choisir le personnel</option>
	                                                 ...
	                                                 {
	                                                 ?>
        <option value="<?php echo''.$rom['id_personnel'].''; ?>"><?php echo'('.stripslashes($rom['matricule_personnel']).') '.stripslashes($rom['nom_personnel']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
                ...
                <option value="">Choisir le service</option>
	                                                 ...
	                                                 {
	                                                 ?>
                         <option value="<?php echo''.$rom_1['id_service'].''; ?>"><?php echo''.stripslashes($rom_1['lib_service']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
								...
								<div class="col-lg-4 col-xs-12" style="margin-top:10px;">
		<select class="form-control" data-trigger  id="recher_fonction" title="Choisir une fonction..." data-width="100%" style="margin-top:10px;">
        <option value="">Choisir la fonction</option>
	                                                 ...
	                                                 {
	                                                 ?>
                         <option value="<?php echo''.$rom_2['id_fonction'].''; ?>"><?php echo''.stripslashes($rom_2['lib_fonction']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
								...
								<div class="col-lg-4 col-xs-12" style="margin-top:10px;">
					<select class="form-control" data-trigger  id="recher_statut" data-width="100%" style="margin-top:10px;">
                    <option value="">Choisir le statut</option>
	                                               ...
	                                               $rem_3=$con->prepare("SELECT * FROM statut_personnel ORDER BY lib_statut_personnel ASC");
	                                                 ...
	                                                 {
	                                                 ?>
  <option value="<?php echo''.$rom_3['id_statut_personnel'].''; ?>"><?php echo''.stripslashes($rom_3['lib_statut_personnel']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
								...
								<div class="col-lg-4 col-xs-12" style="margin-top:10px;">
			<select class="form-control" data-trigger  id="recher_sexe" data-width="100%" style="margin-top:10px;">	
  ...
  <div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_pers" aria-hidden="true" id="modal_pers">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">                
										...
										<div class="col-lg-4" style="/*background-color: #F7F7F7; border:1px solid #D1D1D1;*/ height:207px; ">
										...
										<!---->
										 ...
										 <div class="form-group">
					                            <label class="col-lg-12 control-label">Matricule<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
					                                <input type="text" class="form-control" name="mat" id="mat" placeholder="Matricule">
					                            </div>
					                        </div>
					                        <div class="form-group">
					                            <label class="col-lg-12 control-label">Nom & prénom(s)<span class="rouge">*</span></label>
					                            <div class="col-lg-12s">
					                                <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom & prénom(s)">
					                            </div>
					                        </div>
											<div class="form-group">
					                            <label class="col-lg-12 control-label"  style="margin-top:10px">Sexe<span class="rouge">*</span></label>
					                            <div class="col-lg-12">
					                                <div class="radio">
					                                    <input id="mascu" class="magic-radio" type="radio" name="sexe" value="1">
					                                    <label for="mascu">Masculin</label>
					
					                                    <input id="fem" class="magic-radio" type="radio" name="sexe" value="2">
					                                    <label for="fem">Féminin</label>
					                                </div>
					                            </div>
					                        </div>
											<div class="form-group">
					                <label for="demo-msk-date" class="col-md-12 control-label">Date de naissance<span class="rouge">*</span></label>
                            ...
                            -->
											...
											<div class="form-group">
					                            <label class="col-lg-12 control-label">Date d'entrée<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
								   <input type="date" id="date_entre" name="date_entre" class="form-control">
					                            </div>
					                        </div>
											
											<div class="form-group">
					                            <label class="col-lg-12 control-label">Service<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
                                                <select data-trigger class="form-control" id="service" name="service" style="width:100%;">		
                         ...
                         <option value="<?php echo''.$rom_1['id_service'].''; ?>"><?php echo''.stripslashes($rom_1['lib_service']).''; ?></option>
											...
											<div class="form-group">
					                            <label class="col-lg-12 control-label">Fonction<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
	           <select data-trigger class="form-control" id="fonctio" title="Choisir une fonction..." name="fonctio" data-live-search="true" data-width="100%" style="margin-top:10px;">
							<option value="">Choisir une fonction...</option>
							                        <?php
	                                                 ...
	                                                 {
	                                                 ?>
                         <option value="<?php echo''.$rom_2['id_fonction'].''; ?>"><?php echo mb_strimwidth(stripslashes($rom_2['lib_fonction']), 0, 25, "..."); ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
											...
											<div class="form-group">
					                            <label class="col-lg-12 control-label">Statut<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
					    <select data-trigger class="form-control selectpicker" id="statut" title="Choisir un statut..." name="statut" data-live-search="true" data-width="100%" style="margin-top:10px;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o"></i> Suppression du personnel</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_actif" aria-hidden="true" id="modal_actif">
								...
								<div class="modal-content">
									...
									<div class="modal-body">                
										...
										<div class="row">
											...
											<div class="form-group">
					                            <label class="col-lg-4 control-label">Motif de sortie<span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
	           <select class="form-control" data-trigger id="actif" title="Choisir un motif de sortie..." name="actif" data-live-search="true" data-width="100%" style="margin-top:10px;">
							<option value="">Choisir un motif de sortie...</option>
							                        <?php
	                                                 ...
	                                                 {
	                                                 ?>
                         <option value="<?php echo''.$rom_2['id_motif'].''; ?>"><?php echo ''.stripslashes($rom_2['lib_motif']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
											...
											<div class="form-group">
					                            <label class="col-lg-4 control-label"><b>Date de sortie</b><span class="rouge">*</span></label>
					                            <div class="col-lg-12" style="margin-bottom:10px">
	                                      			<input type="date" class="form-control" name="date_sortie" id="dp1" placeholder="Date de sortie">
					                            </div>
					                        </div>	
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header detail_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-align-justify fa_jus"></i> Détail du personnel</h4>
      </div>
