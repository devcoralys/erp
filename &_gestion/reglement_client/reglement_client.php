...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | Règlement Clients</title>
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <li><a href="../reglement_client/reglement_client.php" data-key="t-p-list" style="background-color:#251f75; color:#fff;">Reglement clients</a></li>
...
<!-- Left Sidebar End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_reglement_client" data-toggle="modal" data-target="#myModal_reglement_client" style="margin:10px; " class="btn btn-success"><i class="fa fa-">+</i> Enregistrer une facture normalisée</button>
                            </div>
 ...
 <!--
    ...
    <a href="excel/excel_reglement_client.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_reglement_client">
...
<!-- Modal reglement_client -->
<!-- Modal -->
<div class="modal fade" id="myModal_reglement_client" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_reglement_client" id="form_reglement_client" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_reglement_client" name="date_reglement_client" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-6 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_dossier_reglement_client" name="num_dossier_reglement_client" />
            </div>	
            
             <div class="col-lg-6 col-xs-12">
                <label>Nom du client<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_reglement_client" name="nom_client_reglement_client" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-3 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_reglement_client" name="montant_reglement_client" />
            </div>
            
            <div class="col-lg-3 col-xs-12">
                <label>Dépenses<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="depense_reglement_client" name="depense_reglement_client" />
            </div>
            
            <div class="col-lg-3 col-xs-12">
                <label>Bénéfice<span class="semi_aste">*</span></label>
                <input readonly style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="benefice_reglement_client" name="benefice_reglement_client" />
            </div>
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_reglement_client" name="motif_reglement_client"></textarea>
            </div>		
...
<div class="modal fade mod_pop" id="myModal_reglement_client_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification reglement_client</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_reglement_client_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_reglement_client_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression reglement_client</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_reglement_client_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_reglement_client_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal reglement_client-->
