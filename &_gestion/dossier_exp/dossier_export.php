...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php include('../titre_ent_1.php'); ?> | Dossiers exportation</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <a href="ajouter_dossier_export.php" class="btn btn-light">
                                                        <i class="uil uil-plus me-1"></i> Créer un dossier
                                                    </a>
                                                </div>
                                                <div class="mb-3">
                                                    <a href="importer_dossier_export.php" class="btn btn-light">
