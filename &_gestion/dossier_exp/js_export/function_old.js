...
$('#form_article').live('submit',function(){		 
	...
	$.ajax({
	type: "POST",
	url: "dossier_export/ajout_article.php",
...
$('#form_container').live('submit',function(){		 
	...
	$.ajax({
	type: "POST",
	url: "dossier_export/ajout_container.php",
...
$('#submit_form').live('click', function(){
	...
	$.ajax({
		type: "POST",
		url: "dossier_export/ajout_dossier.php",
		...
		success: function(msg){
			 ...
			 {
			  $(location).attr('href', 'dossier_export.php');
			 }
		}
	 });
 return false;
...
$('input[name=transport_deja_paye]').live('change', function(){
	...
	if( $('input[name=transport_deja_paye]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_transport.php",
			cache: false,
...
$('#date_depart_expedition').on('keyup', function(){
		...
		var date_depart_expedition=$("#date_depart_expedition").val();
			$("#aff_depart_expedition").hide();

		$.ajax({
			type: "POST",
			data: "date_depart_expedition="+date_depart_expedition,
			url: "dossier_export/update_date_depart_expedition.php",
			cache: false,
			success: function(result){
				$("#aff_depart_expedition").html(date_depart_expedition).show();
			}
	 	});
});
...
$('#date_arrivee').on('keyup', function(){
		...
		$.ajax({
			...
			url: "dossier_export/update_date_arrivee.php",
			cache: false,
			success: function(result){
...
$('#pays_provenance').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_pays_provenance.php",
		cache: false,
		success: function(result){
...
$('#transporteur').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_transporteur.php",
		cache: false,
		success: function(result){
...
$('#num_connaissement').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_num_connaissement.php",
		cache: false,
		success: function(result){
...
$('#num_voyage').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_num_voyage.php",
		cache: false,
		success: function(result){
...
$('#code_bateau').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_code_bateau.php",
		cache: false,
		success: function(result){
...
$('#masse_net').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_masse_net.php",
		cache: false,
		success: function(result){
...
$('#masse_brute').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_masse_brute.php",
		cache: false,
		success: function(result){
...
$('#total_colis').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_total_colis.php",
		cache: false,
		success: function(result){
...
//Etape 1 || Port de dechargement
$('#port_dechargement').on('keyup', function(){

	var port_dechargement=$("#port_dechargement").val();

	$("#aff_port_dechargement").hide();

	$.ajax({
		type: "POST",
		data: "port_dechargement="+port_dechargement,
		url: "dossier_export/update_port_dechargement.php",
		cache: false,
		success: function(result){
			$("#port_dechargement").val(port_dechargement);
		}
	 });
});
...
$('#destinataire').on('keyup', function(){
	...
	$("#aff_destinataire").hide();

	$.ajax({
		type: "POST",
		data: "destinataire="+destinataire,
		url: "dossier_export/update_destinataire.php",
		cache: false,
		success: function(result){
...
//Etape 1 || Lieu empotage
$('#lieu_empotage').on('keyup', function(){

	var lieu_empotage=$("#lieu_empotage").val();

	$("#aff_lieu_empotage").hide();

	$.ajax({
		type: "POST",
		data: "lieu_empotage="+lieu_empotage,
		url: "dossier_export/update_lieu_empotage.php",
		cache: false,
		success: function(result){
			$("#lieu_empotage").val(lieu_empotage);
		}
	 });
});
...
$('#tirage_declaration').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_tirage_declaration.php",
		cache: false,
		success: function(result){
...
$('#sydam').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "sydam="+sydam,
		url: "dossier_export/update_sydam.php",
		cache: false,
		success: function(result){
...
$('#fiche_assurance').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_fiche_assurance.php",
		cache: false,
		success: function(result){
...
$('#fret').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "fret="+fret,
		url: "dossier_export/update_fret.php",
		cache: false,
		success: function(result){

			$("#total_frais_transport").hide();
		var total_frais_transport=parseFloat($('#fret').val())+parseFloat($('#fuel_surcharge').val())+parseFloat($('#irc').val())+parseFloat($('#avisecure').val())+parseFloat($('#pmp').val())+parseFloat($('#frais_lta').val())+parseFloat($('#frais_nas').val());
		$("#total_frais_transport").html(
	
			new Intl.NumberFormat('fr', {
				style: 'currency',
				currency: 'XOF',
				currencySign: 'accounting'
			}).format(total_frais_transport)
			
		).show();

		var net_a_payer=
		parseFloat(total_frais_transport)+parseFloat(total_frais_transit)+parseFloat(total_frais_phyto)+parseFloat(total_frais_compagnie)+parseFloat($("#had_exp").val())
		;
...
//Etape 2 || Fuel surcharge
$('#fuel_surcharge').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_fuel_surcharge.php",
		cache: false,
		success: function(result){
...
$('#irc').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "irc="+irc,
		url: "dossier_export/update_irc.php",
		cache: false,
		success: function(result){
...
//Etape 2 || AVISECURE
$('#avisecure').on('keyup', function(){

	var avisecure=$("#avisecure").val();

	$.ajax({
		type: "POST",
		data: "avisecure="+avisecure,
		url: "dossier_export/update_avisecure.php",
		cache: false,
		success: function(result){
...
$('#pmp').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "pmp="+pmp,
		url: "dossier_export/update_pmp.php",
		cache: false,
		success: function(result){
...
//Etape 2 || frais_lta
$('#frais_lta').on('keyup', function(){

	var frais_lta=$("#frais_lta").val();

	$.ajax({
		type: "POST",
		data: "frais_lta="+frais_lta,
		url: "dossier_export/update_frais_lta.php",
		cache: false,
		success: function(result){
...
//Etape 2 || frais_nas
$('#frais_nas').on('keyup', function(){

	var frais_nas=$("#frais_nas").val();

	$.ajax({
		type: "POST",
		data: "frais_nas="+frais_nas,
		url: "dossier_export/update_frais_nas.php",
		cache: false,
		success: function(result){
...
$('#ts').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "ts="+ts,
		url: "dossier_export/update_ts.php",
		cache: false,
		success: function(result){
			
			$("#total_frais_transit").hide();
		var total_frais_transit=parseFloat($('#tirage_declaration').val())+parseFloat($('#sydam').val())+parseFloat($('#ts').val())+parseFloat($('#co_eur1').val())+parseFloat($('#fiche_empotage').val())+parseFloat($('#intervention_douane').val())+parseFloat($('#redressement').val())+parseFloat($('#visite_douane').val())+parseFloat($('#manutention').val())+parseFloat($('#dgd').val())+parseFloat($('#absence_d3').val())+parseFloat($('#amende_douane').val())+parseFloat($('#acceptation_nas').val())+parseFloat($('#tc_supplementaire').val())+parseFloat($('#rectf').val());
		$("#total_frais_transit").html(
	
			new Intl.NumberFormat('fr', {
				style: 'currency',
				currency: 'XOF',
				currencySign: 'accounting'
			}).format(total_frais_transit)
...
//Etape 2 || co_eur1
$('#co_eur1').on('keyup', function(){

	var co_eur1=$("#co_eur1").val();

	$.ajax({
		type: "POST",
		data: "co_eur1="+co_eur1,
		url: "dossier_export/update_co_eur1.php",
		cache: false,
		success: function(result){
...
//Etape 2 || fiche_empotage
$('#fiche_empotage').on('keyup', function(){

	var fiche_empotage=$("#fiche_empotage").val();

	$.ajax({
		type: "POST",
		data: "fiche_empotage="+fiche_empotage,
		url: "dossier_export/update_fiche_empotage.php",
		cache: false,
		success: function(result){
...
//Etape 2 || intervention_douane
$('#intervention_douane').on('keyup', function(){

	var intervention_douane=$("#intervention_douane").val();

	$.ajax({
		type: "POST",
		data: "intervention_douane="+intervention_douane,
		url: "dossier_export/update_intervention_douane.php",
		cache: false,
		success: function(result){
...
//Etape 2 || redressement
$('#redressement').on('keyup', function(){

	var redressement=$("#redressement").val();

	$.ajax({
		type: "POST",
		data: "redressement="+redressement,
		url: "dossier_export/update_redressement.php",
		cache: false,
		success: function(result){
...
//Etape 2 || visite_douane
$('#visite_douane').on('keyup', function(){

	var visite_douane=$("#visite_douane").val();

	$.ajax({
		type: "POST",
		data: "visite_douane="+visite_douane,
		url: "dossier_export/update_visite_douane.php",
		cache: false,
		success: function(result){
...
$('#manutention').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_manutention.php",
		cache: false,
		success: function(result){
...
$('#dgd').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "dgd="+dgd,
		url: "dossier_export/update_dgd.php",
		cache: false,
		success: function(result){
...
//Etape 2 || absence_d3
$('#absence_d3').on('keyup', function(){

	var absence_d3=$("#absence_d3").val();

	$.ajax({
		type: "POST",
		data: "absence_d3="+absence_d3,
		url: "dossier_export/update_absence_d3.php",
		cache: false,
		success: function(result){
...
//Etape 2 || amende_douane
$('#amende_douane').on('keyup', function(){

	var amende_douane=$("#amende_douane").val();

	$.ajax({
		type: "POST",
		data: "amende_douane="+amende_douane,
		url: "dossier_export/update_amende_douane.php",
		cache: false,
		success: function(result){
...
//Etape 2 || acceptation_nas
$('#acceptation_nas').on('keyup', function(){

	var acceptation_nas=$("#acceptation_nas").val();

	$.ajax({
		type: "POST",
		data: "acceptation_nas="+acceptation_nas,
		url: "dossier_export/update_acceptation_nas.php",
		cache: false,
		success: function(result){
...
//Etape 2 || tc_supplementaire
$('#tc_supplementaire').on('keyup', function(){

	var tc_supplementaire=$("#tc_supplementaire").val();

	$.ajax({
		type: "POST",
		data: "tc_supplementaire="+tc_supplementaire,
		url: "dossier_export/update_tc_supplementaire.php",
		cache: false,
		success: function(result){
...
$('#rectf').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "rectf="+rectf,
		url: "dossier_export/update_rectf.php",
		cache: false,
		success: function(result){
...
//Etape 2 || certificat_phytosanitaire
$('#certificat_phytosanitaire').on('keyup', function(){

	var certificat_phytosanitaire=$("#certificat_phytosanitaire").val();

	$.ajax({
		type: "POST",
		data: "certificat_phytosanitaire="+certificat_phytosanitaire,
		url: "dossier_export/update_certificat_phytosanitaire.php",
		cache: false,
		success: function(result){
			
		$("#total_frais_phyto").hide();
		var total_frais_phyto=parseFloat($('#autorisation_maq').val())+parseFloat($('#agent_phyto').val())+parseFloat($('#certificat_phytosanitaire').val())+parseFloat($('#rapport_journalier').val());
		$("#total_frais_phyto").html(
	
			new Intl.NumberFormat('fr', {
				style: 'currency',
				currency: 'XOF',
				currencySign: 'accounting'
			}).format(total_frais_phyto)
...
//Etape 2 || autorisation_maq
$('#autorisation_maq').on('keyup', function(){

	var autorisation_maq=$("#autorisation_maq").val();

	$.ajax({
		type: "POST",
		data: "autorisation_maq="+autorisation_maq,
		url: "dossier_export/update_autorisation_maq.php",
		cache: false,
		success: function(result){
...
//Etape 2 || agent_phyto
$('#agent_phyto').on('keyup', function(){

	var agent_phyto=$("#agent_phyto").val();

	$.ajax({
		type: "POST",
		data: "agent_phyto="+agent_phyto,
		url: "dossier_export/update_agent_phyto.php",
		cache: false,
		success: function(result){
...
//Etape 2 || rapport_journalier
$('#rapport_journalier').on('keyup', function(){

	var rapport_journalier=$("#rapport_journalier").val();

	$.ajax({
		type: "POST",
		data: "rapport_journalier="+rapport_journalier,
		url: "dossier_export/update_rapport_journalier.php",
		cache: false,
		success: function(result){
...
//Etape 2 || posit_relevage
$('#posit_relevage').on('keyup', function(){

	var posit_relevage=$("#posit_relevage").val();

	$.ajax({
		type: "POST",
		data: "posit_relevage="+posit_relevage,
		url: "dossier_export/update_posit_relevage.php",
		cache: false,
		success: function(result){
			
		$("#total_frais_compagnie").hide();
		var total_frais_compagnie=parseFloat($('#posit_relevage').val())+parseFloat($('#edition_eir').val())+parseFloat($('#pesage_manut').val())+parseFloat($('#msr').val())+parseFloat($('#abidjan_terminal').val())+parseFloat($('#waybill').val())+parseFloat($('#surpoids').val())+parseFloat($('#detention_container').val())+parseFloat($('#expedition_dhl').val());
		$("#total_frais_compagnie").html(
	
			new Intl.NumberFormat('fr', {
				style: 'currency',
				currency: 'XOF',
				currencySign: 'accounting'
			}).format(total_frais_compagnie)
...
//Etape 2 || edition_eir
$('#edition_eir').on('keyup', function(){

	var edition_eir=$("#edition_eir").val();

	$.ajax({
		type: "POST",
		data: "edition_eir="+edition_eir,
		url: "dossier_export/update_edition_eir.php",
		cache: false,
		success: function(result){
...
//Etape 2 || pesage_manut
$('#pesage_manut').on('keyup', function(){

	var pesage_manut=$("#pesage_manut").val();

	$.ajax({
		type: "POST",
		data: "pesage_manut="+pesage_manut,
		url: "dossier_export/update_pesage_manut.php",
		cache: false,
		success: function(result){
...
$('#msr').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "msr="+msr,
		url: "dossier_export/update_msr.php",
		cache: false,
		success: function(result){
...
//Etape 2 || abidjan_terminal
$('#abidjan_terminal').on('keyup', function(){

	var abidjan_terminal=$("#abidjan_terminal").val();

	$.ajax({
		type: "POST",
		data: "abidjan_terminal="+abidjan_terminal,
		url: "dossier_export/update_abidjan_terminal.php",
		cache: false,
		success: function(result){
...
$('#waybill').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_waybill.php",
		cache: false,
		success: function(result){
...
//Etape 2 || surpoids
$('#surpoids').on('keyup', function(){

	var surpoids=$("#surpoids").val();

	$.ajax({
		type: "POST",
		data: "surpoids="+surpoids,
		url: "dossier_export/update_surpoids.php",
		cache: false,
		success: function(result){
...
//Etape 2 || detention_container
$('#detention_container').on('keyup', function(){

	var detention_container=$("#detention_container").val();

	$.ajax({
		type: "POST",
		data: "detention_container="+detention_container,
		url: "dossier_export/update_detention_container.php",
		cache: false,
		success: function(result){
...
//Etape 2 || expedition_dhl
$('#expedition_dhl').on('keyup', function(){

	var expedition_dhl=$("#expedition_dhl").val();

	$.ajax({
		type: "POST",
		data: "expedition_dhl="+expedition_dhl,
		url: "dossier_export/update_expedition_dhl.php",
		cache: false,
		success: function(result){
...
$('#agio').on('change', function(){
	...
	$.ajax({
		type: "POST",
		data: "agio="+agio,
		url: "dossier_export/update_agio.php",
		cache: false,
		success: function(result){
...
$('#ouverture_dossier').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_ouverture_dossier.php",
		cache: false,
		success: function(result){
...
$('#acconage').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_acconage.php",
		cache: false,
		success: function(result){
...
$('#surestarie').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_surestarie.php",
		cache: false,
		success: function(result){
...
$('#echange_bl').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_echange_bl.php",
		cache: false,
		success: function(result){
...
$('#caution').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_caution.php",
		cache: false,
		success: function(result){
...
$('#livraison').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_livraison.php",
		cache: false,
		success: function(result){
...
$('#ts_douane').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_ts_douane.php",
		cache: false,
		success: function(result){
...
$('#retrait_documentaire').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_retrait_documentaire.php",
		cache: false,
		success: function(result){
...
$('#debours_divers').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_debours_divers.php",
		cache: false,
		success: function(result){
...
$('#documentation_weeb').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_documentation_weeb.php",
		cache: false,
		success: function(result){
...
$('#bsc').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "bsc="+bsc,
		url: "dossier_export/update_bsc.php",
		cache: false,
		success: function(result){
...
$('#certificat_phyto').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_certificat_phyto.php",
		cache: false,
		success: function(result){
...
$('#api').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "api="+api,
		url: "dossier_export/update_api.php",
		cache: false,
		success: function(result){
...
$('#aiae').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "aiae="+aiae,
		url: "dossier_export/update_aiae.php",
		cache: false,
		success: function(result){
...
$('#certificat_veterinaire').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_certificat_veterinaire.php",
		cache: false,
		success: function(result){
...
$('#appurement_magasin').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_appurement_magasin.php",
		cache: false,
		success: function(result){
...
$('#magasinage').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_magasinage.php",
		cache: false,
		success: function(result){
...
$('#sortie_pc').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_sortie_pc.php",
		cache: false,
		success: function(result){
...
$('#commission').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_commission.php",
		cache: false,
		success: function(result){
...
$('#escorte').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_escorte.php",
		cache: false,
		success: function(result){
...
$('#nature').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "nature="+nature,
		url: "dossier_export/update_nature.php",
		cache: false,
		success: function(result){
...
//Etape 2 || Livraison
$('#had_exp').on('keyup', function(){

	var had_exp=$("#had_exp").val();

	$.ajax({
		type: "POST",
		data: "had_exp="+had_exp,
		url: "dossier_export/update_had_exp.php",
		cache: false,
		success: function(result){
...
//alert(parseFloat(r_dt)+parseFloat(r_sydam)+parseFloat(r_agio)+parseFloat(r_ts_douane)+parseFloat(r_bsc)+parseFloat(r_api)+parseFloat(r_assurance)+parseFloat(r_certificat_phyto)+parseFloat(r_magasinage)+parseFloat(r_manutention)+parseFloat(r_echange_bl)+parseFloat(r_acconage)+parseFloat(r_surestarie)+parseFloat(r_caution)+parseFloat(r_livraison)+parseFloat(r_transport_agent)+parseFloat(r_commission)+parseFloat(r_retrait_documentaire)+parseFloat(r_manifeste));
	...
	if($('#r_mode_paiement').val()==1) //Si payé au comptant
	{
		...
		$.ajax({
			type: "POST",
			data: "r_agio="+r_agio,
			url: "dossier_export/update_r_agio.php",
			cache: false,
			success: function(result){
			}
		 });
...
$.ajax({
	type: "POST",
	url: "dossier_export/stock_montant_reel.php",
...
$('#r_num_declaration').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_num_declaration.php",
		cache: false,
		success: function(result){
...
$('#r_mode_paiement').live('change', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_mode_paiement.php",
		cache: false,
		success: function(result){
...
$('#r_liquidation').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_liquidation.php",
		cache: false,
		success: function(result){
...
$('#r_num_quittance').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_num_quittance.php",
		cache: false,
		success: function(result){
			$("#montant_reel").hide();
		var total_formalite=parseFloat(r_dt)+parseFloat(r_sydam)+parseFloat(r_agio)+parseFloat(r_ts_douane)+parseFloat(r_bsc)+parseFloat(r_api)+parseFloat(r_assurance)+parseFloat(r_certificat_phyto)+parseFloat(r_magasinage)+parseFloat(r_manutention)+parseFloat(r_echange_bl)+parseFloat(r_acconage)+parseFloat(r_surestarie)+parseFloat(r_caution)+parseFloat(r_livraison)+parseFloat(r_transport_agent)+parseFloat(r_commission)+parseFloat(r_retrait_documentaire)+parseFloat(r_manifeste);
...
$('#r_dt').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "r_dt="+r_dt,
		url: "dossier_export/update_r_dt.php",
		cache: false,
		success: function(result){
...
$('#r_sydam').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_sydam.php",
		cache: false,
		success: function(result){
...
$('#r_ts_douane').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_ts_douane.php",
		cache: false,
		success: function(result){
...
$('#r_bsc').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "r_bsc="+r_bsc,
		url: "dossier_export/update_r_bsc.php",
		cache: false,
		success: function(result){
...
$('#r_api').on('keyup', function(){
	...
	$.ajax({
		type: "POST",
		data: "r_api="+r_api,
		url: "dossier_export/update_r_api.php",
		cache: false,
		success: function(result){
...
$('#r_assurance').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_assurance.php",
		cache: false,
		success: function(result){
...
$('#r_certificat_phyto').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_certificat_phyto.php",
		cache: false,
		success: function(result){
...
$('#r_magasinage').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_magasinage.php",
		cache: false,
		success: function(result){
...
$('#r_manutention').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_manutention.php",
		cache: false,
		success: function(result){
...
$('#r_echange_bl').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_echange_bl.php",
		cache: false,
		success: function(result){
...
$('#r_surestarie').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_surestarie.php",
		cache: false,
		success: function(result){
...
$('#r_caution').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_caution.php",
		cache: false,
		success: function(result){
...
$('#r_livraison').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_livraison.php",
		cache: false,
		success: function(result){
...
$('#r_transport_agent').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_transport_agent.php",
		cache: false,
		success: function(result){
...
$('#r_commission').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_commission.php",
		cache: false,
		success: function(result){
...
$('#r_retrait_documentaire').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_retrait_documentaire.php",
		cache: false,
		success: function(result){
...
$('#r_manifeste').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_manifeste.php",
		cache: false,
		success: function(result){
...
$('#r_acconage').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_r_acconage.php",
		cache: false,
		success: function(result){
...
$('#nom_fournisseur').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_nom_fournisseur.php",
		cache: false,
		success: function(result){
...
$('#date_declaration_bl').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_date_declaration_bl.php",
		cache: false,
		success: function(result){
			//$("#nom_fournisseur").html(nom_fournisseur).show();
		}
...
$('#date_lta_bl').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_date_lta_bl.php",
		cache: false,
		success: function(result){
			//$("#nom_fournisseur").html(nom_fournisseur).show();
		}
...
$('#waybill_bl').on('keyup', function(){
	...
	$.ajax({
		...
		url: "dossier_export/update_waybill_bl.php",
		cache: false,
		success: function(result){
			//$("#nom_fournisseur").html(nom_fournisseur).show();
		}
...
$('input[name=facture_fournisseur]').live('change', function(){
	...
	if( $('input[name=facture_fournisseur]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_facture_fournisseur.php",
			cache: false,
			success: function(result){
...
$('input[name=bon_a_enlever]').live('change', function(){
	...
	if( $('input[name=bon_a_enlever]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_bon_a_enlever.php",
			cache: false,
			success: function(result){
...
$('input[name=copie_lta]').live('change', function(){
	...
	if( $('input[name=copie_lta]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_copie_lta.php",
			cache: false,
			success: function(result){
...
$('input[name=liste_colisage]').live('change', function(){
	...
	if( $('input[name=liste_colisage]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_liste_colisage.php",
			cache: false,
			success: function(result){
...
$('input[name=autre_document]').live('change', function(){
	...
	if( $('input[name=autre_document]').is(':checked') ){
		...
		$.ajax({
			...
			url: "dossier_export/update_autre_document.php",
			cache: false,
			success: function(result){
...
$(".edit_article").live('click', function() {
	...
	$.ajax({
	 type: "GET",
     url: "dossier_export/form_modifier_article.php",
     data: "ref="+id_ref,
	 success: function(msg){
 ...
 $('#form_article_mod').live('submit',function(){
	  ...
	  $(".delete_article").live('click', function() {
		...
		$.ajax({
		 type: "GET",
		 url: "dossier_export/form_supprimer_article.php",
		 data: "ref="+id_ref,
		 success: function(msg){
	 ...
	 $('#submit_sup_article').live('click',function(){						 
		   $.ajax({
			   type: "POST",
			   url: "dossier_export/sup_article.php",
			   success: function(msg){  
				change_page_article('0');
	...
	$("#tirage_declaration").on('keyup', function(){
		...
		$.ajax({
			type: "POST",
			url: "dossier_export/stock_nap.php",
	...
	$("#net_a_payer").hide();
		...
		//Calcul Net A Payer
		$("#net_a_payer").val(parseFloat(total_frais_transport)+parseFloat(total_frais_transit)+parseFloat(total_frais_phyto)+parseFloat(total_frais_compagnie)+parseFloat($("#had_exp").val()));
		...
		$('#upload_doc').live('submit',function(){
			...
			$.ajax({
			type: "POST",
			url: "dossier_export/upload_doc.php",
			dataType: 'text', 
			cache: false,
			contentType: false,
			processData: false, 
		...
		//Export DOCX etat codage export
		$('#export_etat_codage_export').live('click', function(){

			alert($("#etat_codage_export").html());

			var etat_codage_export=$("#etat_codage_export").html();
		
			$.ajax({
				type: "POST",
				data: "etat_codage_export="+etat_codage_export,
				url: "exportation/word/export_etat_codage_export.php",
				cache: false,
				success: function(result){
...
function change_page_dossier_maritime(page_id_cons){
	...
	$.ajax({
			type: "POST",
			url: "dossier_export/charge_dossier_maritime.php",
			data: dataString,
			cache: false,
...
function change_page_dossier_aerien(page_id_cons){
	...
	$.ajax({
			type: "POST",
			url: "dossier_export/charge_dossier_aerien.php",
			data: dataString,
			cache: false,
			beforeSend: function(result){
				$("div.chargement").html('<img src="../../img/giphy.gif" style="width:55px; height:55px;" />').show();
...
function change_page_dossier_actif(page_id_cons){
	...
	$.ajax({
			type: "POST",
			url: "dossier_export/charge_dossier_actif.php",
			data: dataString,
			cache: false,
			beforeSend: function(result){
				$("div.chargement").html('<img src="../../img/giphy.gif" style="width:55px; height:55px;" />').show();
...
function change_page_article(page_id_cons){
	...
	$.ajax({
			type: "POST",
			url: "dossier_export/charge_article.php",
			data: dataString,
			cache: false,
			success: function(result){
				$("div.chargement").html('<img src="../../img/giphy.gif" style="width:55px; height:55px;" />').hide();
