...
$n=$con->query('SELECT * FROM dossier_exp WHERE import=0 AND export=1 ');
$n->execute();
$nb=$n->rowcount();
$nb_new=$nb+1;
$num_dossier='S-EX00'.$nb_new.'/'.gmdate("Y");
...
{
$req=$con->prepare("INSERT INTO dossier_exp(time_dossier, num_dossier, nom_dossier, description_dossier, date_int_dossier, service_dossier_id, date_creat_dossier, secur_ajout_dossier, client_id, type_transit_id, ts_douane, export, import) VALUES (:A, :B, :C, :D, :E, :F, :G, :H, :I, :J, :K, :L, :M)");
