<?php
  ...
  var dataString = 'page_id_cons='+ page_id_cons;
    ...
    $requete=" SELECT * FROM dossier_exp WHERE id_dossier!='' AND type_transit_id=2 AND export=1 AND import=0 ";
...
*/
    ...
    $req=" SELECT * FROM dossier_exp WHERE id_dossier!='' AND type_transit_id=2 AND export=1 AND import=0 ";
