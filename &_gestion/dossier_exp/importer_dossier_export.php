...
<!-- Left Sidebar End -->
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-lg-3 toolbar-right">
                                    <div class="row">
                                       ...
                                       <!--<button class="btn btn-purple export_pers" style="margin:2px;"><i class="fa fa-download"></i> Télécharger un fichier exemple</button>-->
                                        </div>
                                    </div>    
                                </div>
                            </div>
    ...
    <form action="client/import_client.php" method="post" enctype="multipart/form-data">
	           ...
	           <select data-trigger class="form-control" id="fonctio" title="Choisir une fonction..." name="fonctio" data-live-search="true" data-width="100%" style="margin-top:10px;">
					    ...
					    <select data-trigger class="form-control selectpicker" id="statut" title="Choisir un statut..." name="statut" data-live-search="true" data-width="100%" style="margin-top:10px;">
	                                               ...
	                                               $rem_3=$con->prepare("SELECT * FROM statut_pers_soignant ORDER BY lib_statut_pers_soignant ASC");
	                                                 ...
	                                                 {
	                                                 ?>
  <option value="<?php echo''.$rom_3['code_statut_pers_soignant'].''; ?>"><?php echo''.stripslashes($rom_3['lib_statut_pers_soignant']).''; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
