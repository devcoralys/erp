...
$r_fret=$info['r_fret'];
$r_fuel_surcharge=$info['r_fuel_surcharge'];
$r_irc=$info['r_irc'];
$r_pmp=$info['r_pmp'];
$r_avisecure=$info['r_avisecure'];
$r_frais_lta=$info['r_frais_lta'];
$r_frais_nas=$info['r_frais_nas'];
$r_tirage_declaration=$info['r_tirage_declaration'];
$r_sydam=$info['r_sydam'];
$r_ts=$info['r_ts'];
$r_co_eur1=$info['r_co_eur1'];
$r_fiche_empotage=$info['r_fiche_empotage'];
$r_intervention_douane=$info['r_intervention_douane'];   
$r_redressement=$info['r_redressement'];
$r_visite_douane=$info['r_visite_douane'];    
$r_manutention=$info['r_manutention'];    
$r_certificat_phytosanitaire=$info['r_certificat_phytosanitaire'];   
$r_dgd=$info['r_dgd'];  
$r_absence_d3=$info['r_absence_d3'];  
$r_amende_douane=$info['r_amende_douane']; 
$r_acceptation_nas=$info['r_acceptation_nas']; 
$r_tc_supplementaire=$info['r_tc_supplementaire']; 
$r_rectf=$info['r_rectf']; 
$r_autorisation_maq=$info['r_autorisation_maq']; 
$r_rapport_journalier=$info['r_rapport_journalier']; 
$r_agent_phyto=$info['r_agent_phyto']; 
$r_posit_relevage=$info['r_posit_relevage']; 
$r_edition_eir=$info['r_edition_eir']; 
$r_pesage_manut=$info['r_pesage_manut']; 
$r_msr=$info['r_msr']; 
$r_abidjan_terminal=$info['r_abidjan_terminal']; 
$r_waybill=$info['r_waybill']; 
$r_surpoids=$info['r_surpoids']; 
$r_detention_conteneur=$info['r_detention_conteneur']; 
$r_expedition_dhl=$info['r_expedition_dhl']; 
$r_autre=$info['r_autre'];                                          
                                                    ...
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="d-flex align-items-center mt-4">
                                                            ...
                                                            <div class="flex-grow-1" style="font-size:15px;">
                                                                ...
                                                                <p class="text-muted mb-0" id="aff_num_declaration"> <?php echo isset($r_num_declaration) ? $r_num_declaration : 0 ; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                    ...
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="d-flex align-items-center mt-4">
                                                            ...
                                                            <div class="flex-grow-1" style="font-size:15px;">
                                                                ...
                                                                <p class="text-muted mb-0" id="aff_liquidation"> <?php echo isset($r_liquidation) ? $r_liquidation : 0 ; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <span class="font-size-16 mb-0">Montant de la cotation </span><b style="color:green;">
                                                                        <?php
                                                                        if(isset($_SESSION['net_a_payer']))
                                                                        {
                                                                         echo number_format(floatval($_SESSION['net_a_payer']),0,',',' '); 
                                                                        }
                                                                        else
                                                                        {
                                                                         echo '
                                                                            <a class="btn btn-warning" href="detail_dossier_import.php?ref_dos='.$_SESSION['ref_dos'].'">Veuillez actualiser le montant svp !</a>
                                                                         ';
                                                                        }
                                                                        ?>      
                                                                        FCFA</b></br>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="r_num_declaration">Numéro Déclaration</label>
                                                            ...
                                                            <input class="form-control" type="text"  id="r_num_declaration" value="<?php echo isset($r_num_declaration) ? $r_num_declaration : 0 ; ?>">
                                               
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="r_num_declaration">Mode de paiement</label>
                                                        <?php
$r_mode_paiement = isset($r_mode_paiement) ? $r_mode_paiement : 0;
                                                        ?>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="r_liquidation">Liquidation</label>
                                                            <input class="form-control" type="text"  id="r_liquidation" value="<?php echo isset($r_liquidation) ? $r_liquidation : 0 ; ?>">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="r_num_quittance">N° Quittance</label>
                                                            <input class="form-control" type="text"  id="r_num_quittance" value="<?php echo isset($r_num_quittance) ? $r_num_quittance : 0 ; ?>">
                                                    </div>
                                                </div><!-- end row -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="r_fret">FRET</label>
                                                            <input class="form-control" type="number"  id="r_fret" value="<?php echo isset($r_fret) ? $r_fret : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_fret">FUEL SURCHARGE (PMY)</label>
                                                            <input class="form-control" type="number"  id="r_fuel_surcharge" value="<?php echo isset($r_fuel_surcharge) ? $r_fuel_surcharge : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_irc">IRC (INSURANCE RISK CHARGES)</label>
                                                            <input class="form-control" type="number"  id="r_irc" value="<?php echo isset($r_irc) ? $r_irc : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_pmp">TAXE PESEE</label>
                                                            <input class="form-control" type="number"  id="r_pmp" value="<?php echo isset($r_pmp) ? $r_pmp : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_avisecure">AVISECURE</label>
                                                            <input class="form-control" type="number"  id="r_avisecure" value="<?php echo isset($r_avisecure) ? $r_avisecure : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_frais_lta">FRAIS LTA</label>
                                                            <input class="form-control" type="number"  id="r_frais_lta" value="<?php echo isset($r_frais_lta) ? $r_frais_lta : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_frais_nas">FRAIS NAS</label>
                                                            <input class="form-control" type="number"  id="r_frais_nas" value="<?php echo isset($r_frais_nas) ? $r_frais_nas : 0 ; ?>">
                                                    </div>
                                                    
                                                    <div class="col-md-2">
                                                        <label for="r_tirage_declaration">TIRAGE DECLARATION</label>
                                                            <input class="form-control" type="number"  id="r_tirage_declaration" value="<?php echo isset($r_tirage_declaration) ? $r_tirage_declaration : 0 ; ?>">
                                                    </div>
                                        ...
                                        <form>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input readonly class="form-control" type="text" id="num_declaration_bl" placeholder="N° de déclaration" value="<?php echo isset($r_num_declaration) ? $r_num_declaration : 0 ; ?>" >
                                                </div>
                                                <div class="col-md-3">
