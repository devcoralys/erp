        ...
        <div class="main-content">
            <div class="page-content">
                        ...
                        <div class="col-12">
                                ...
                                <div class="col-lg-4 toolbar-right">
                                    <div class="row">
                                        <div class="col-lg-12 toolbar-right">
                                            <button style="margin:3px;" class="btn btn-purple add_pers" data-toggle="modal" data-target="#modal_pers"><i class="fa fa-plus"></i> Ajouter un fournisseur</button>
                                            <button style="margin:3px;" class="btn btn-success import_pers"><i class="fa fa-upload"></i> Importer la liste des fournisseurs</button>
                                        </div>
                                    </div>   
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 toolbar-left">
                                    <a href="../../xls/liste_fournisseur.csv"><button style="margin:3px;" class="btn btn-warning"><i class="fa fa-download"></i> Télécharger un modèle</button></a>
                                </div>
                            </div>  
                        </div>
                    </div>
              ...
              <option value="">Choisir le fournisseur</option>
					                                  <?php
	                                                 $rem=$con->prepare("SELECT * FROM fournisseur ORDER BY nom_fournisseur ASC");
                                                     $rem->execute();
                                                     while($rom=$rem->fetch())
	                                                 {
	                                                 ?>
        <option value="<?php echo''.$rom['id_fournisseur'].''; ?>"><?php echo'('.stripslashes($rom['code_fournisseur']).') '.stripslashes($rom['nom_fournisseur']).' - '.stripslashes($rom['tel_fournisseur']).' - '.stripslashes($rom['email_fournisseur']).' '; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>
  ...
  <div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_pers" aria-hidden="true" id="modal_pers">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<h5 class="modal-title"><i class="fa fa-plus"></i> Nouveau fournisseur</h5>
									</div>
										...
										<!---->
										 <div class="col-lg-12">
					                        ...
					                        <div class="form-group">
					                            <label class="col-lg-12 control-label">Nom du fournisseur<span class="rouge">*</span></label>
...
<div class="modal fade mod_pop" id="modal_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
									...
									<h5 class="modal-title">Modification du fournisseur</h5>
									</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o"></i> Suppression du fournisseur</h4>
      </div>
      <div class="modal-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header detail_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-align-justify fa_jus"></i> Détail du fournisseur</h4>
      </div>
