...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | Encaissement</title>
...
<!-- Left Sidebar End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_encaissement" data-toggle="modal" data-target="#myModal_encaissement" style="margin:10px; " class="btn btn-success"><i class="fa fa-">+</i> Effectuer un encaissement</button>
                            </div>
 ...
 <!--
    ...
    <a href="excel/excel_encaissement.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_encaissement">
...
<!-- Modal encaissement -->
<!-- Modal -->
<div class="modal fade" id="myModal_encaissement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus_">+</i> Effectuer un encaissement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_encaissement" id="form_encaissement" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_encaissement" name="date_encaissement" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                <label>N° du Réçu/chèque/Bord. Vir.<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_recu_encaissement" name="num_recu_encaissement" />
            </div>		
            
            <div class="col-lg-8 col-xs-12">
                <label>N° du Dossier<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_dossier_encaissement" name="num_dossier_encaissement" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-6 col-xs-12">
                <label>Nom et Prénom(s) du client<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_encaissement" name="nom_client_encaissement" />
            </div>		
            
            <div class="col-lg-3 col-xs-12">
                <label>Montant<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_encaissement" name="montant_encaissement" />
            </div>
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_encaissement" name="motif_encaissement"></textarea>
            </div>		
...
<div class="modal fade mod_pop" id="myModal_encaissement_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification encaissement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_encaissement_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_encaissement_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression encaissement</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_encaissement_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_encaissement_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
