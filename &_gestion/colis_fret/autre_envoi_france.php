        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <?php if($_SESSION['acces_colis_fret']==1 ){ ?>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a a href="../colis_fret/colis_fret.php" data-key="t-p-grid" style="background-color:#251f75; color:#fff;"> Colis accompagnés</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_colis_fret" data-toggle="modal" data-target="#myModal_colis_fret" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Nouvel envoi extérieur</button>
                        ...
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    ...
                                    <input type="text" class="form-control" name="recher_code_colis_colis_fret" id="recher_code_colis_colis_fret" placeholder="Code colis">
					            </div>
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_colis_fret">
...
<!-- Modal caisse -->
<!-- Modal -->
<div class="modal fade" id="myModal_colis_fret" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_colis_fret" id="form_colis_fret" class="form-horizontal" action="#">
         ...
         <div class="col-lg-4 col-xs-12">
				 ...
				 <input readonly style="background-color:#f9f9f9; height:45px;" type="date" class="form-control" required id="date_colis_fret" name="date_colis_fret" value="<?php echo gmdate('Y-m-d'); ?>"  />
        </div>	
        ...
        <div class="col-lg-4 col-xs-12">
			...
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="expediteur_colis_fret" name="expediteur_colis_fret" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>N° CNI Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="num_cni_expediteur_colis_fret" name="num_cni_expediteur_colis_fret" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_expediteur_colis_fret" name="tel_expediteur_colis_fret" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destinataire [Nom et Prénom(s)]<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destinataire_colis_fret" name="destinataire_colis_fret" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destination<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destination_colis_fret" name="destination_colis_fret" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Destinataire<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_destinataire_colis_fret" name="tel_destinataire_colis_fret" value="" />
        </div>	
        ...
        <div class="col-lg-12 col-xs-12">
				 ...
				 <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="adresse_recuperation_colis_fret" name="adresse_recuperation_colis_fret" value=""  />
            </div>		
		</div>
        <div class="row">
            <div class="col-lg-8 col-xs-12">
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="button" id="envoie_colis_fret" class="btn button_valid"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
