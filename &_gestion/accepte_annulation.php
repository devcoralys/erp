...
$inf=$con->prepare('UPDATE groupage SET annulation=:A, secur_annul=:B WHERE id_groupage=:C');
$inf->execute(array('A'=>2, 'B'=>$_SESSION['secur_site'], 'C'=>$id_groupage));
$info=$inf->fetch();
...
$lib_trace="Annulation du groupage N째 <b>".$time_groupage."</b> ";
