<?php
  ...
  var dataString = 'page_id_cons='+ page_id_cons;
    ...
    $requete=" SELECT * FROM container WHERE id_container!='' AND dossier_id_container=".$dos_id." ";
...
*/
    ...
    $req=" SELECT * FROM container WHERE id_container!='' AND dossier_id_container=".$dos_id."  ";
