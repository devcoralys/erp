<?php
  ...
  var dataString = 'page_id_cons='+ page_id_cons;
    ...
    $requete=" SELECT * FROM dossier WHERE id_dossier!='' AND etat_dossier=1 ";
...
*/
    ...
    $req=" SELECT * FROM dossier WHERE id_dossier!='' AND etat_dossier=1 ";
    ...
    <div class="card shadow-none border">
        <div class="card-body p-3">
            <div>
                ...
                <div>
                    <h5 class="font-size-14 text-truncate"><a href="detail_dossier_export.php" class="text-body">Exportation</a></h5>
                    <div class="mt-3">
                        <p class="text-muted font-size-13 mb-1">12GB of 30GB used</p>
