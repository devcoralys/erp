...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php include('../titre_ent_1.php'); ?> | Dossiers importation</title>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="mb-3">
                                                    <a href="importer_dossier_import.php" class="btn btn-light">
                                                        <i class="fa fa-download"></i> Importer les dossiers
                                                    </a>
                                                </div>
                                            </div><!-- end col -->
                                            <div class="col-md-9">
                                        ...
                                        <div class="mt-2">
                                            <ul class="nav nav-tabs nav-tabs-custom mb-4" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#grid-active" role="tab">Aérien</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#grid-all" role="tab">Maritime</a>
                                                </li>
                                            </ul><!-- end ul -->
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <!-- Tous les dossiers-->
                                            <div class="tab-pane active" id="grid-active" role="tabpanel">

                                                <div class="chargement"></div>
                                                <div class="row aff_dossier_aerien"></div>
                                                
                                            </div>
                                            <!-- /Tous les dossiers -->

                                            <!-- Tous les dossiers-->
                                            <div class="tab-pane" id="grid-all" role="tabpanel">

                                                <div class="chargement"></div>
                                                <div class="row aff_dossier_maritime"></div>
