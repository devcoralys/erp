...
$inf1=$con->prepare('SELECT * FROM dossier_exp WHERE id_dossier=:A');
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="../dossier/dossier_import.php" data-key="t-p-grid" style="background-color:#251f75; color:#fff;">Import</a></li>
...
<!-- Left Sidebar End -->
                                                    ...
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="d-flex align-items-center mt-4">
                                                            ...
                                                            <div class="flex-grow-1" style="font-size:15px;">
                                                                ...
                                                                <p class="text-muted mb-0" id="aff_date_arrivee"> <?php echo $date_arrivee; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                            ...
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <span class="font-size-16 mb-0">Pays de provenance : </span><b><?php echo $pays_provenance; ?> </b></br>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <span class="font-size-16 mb-0">Montant de la cotation </span><b style="color:green;"><?php echo number_format($_SESSION['net_a_payer']+(0.35*floatval($had)),0,',',' '); ?> FCFA</b></br>
                                                                    </div>
                                                                </div>
                                                            </div><!-- end card body -->
                                                        </div><!-- end card -->
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-3">
                                                                        <div class="avatar-sm">
                                                                            <div class="avatar-title bg-light text-primary rounded-circle font-size-18">
                                                                                <!--<i class="uil uil-list-ul"></i>-->
                                                                                <img src="../ico_app/Doc.png" style="width:30px; height:30px;" alt="Documentation importation">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <label for="transport_deja_paye" class="">Transport payé par le client</label>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                                ...
                                                                <input type="date" class="form-control" id="date_arrivee" name="date_arrivee" placeholder="Date d'arrivée" value="<?php echo $date_arrivee; ?>">
                                                        </div>
                                                    
                                                        <div class="col-md-3">
                                                                <label for="pays_provenance">Pays de provenance</label>
                                                                <input type="text" class="form-control" id="pays_provenance" name="pays_provenance" placeholder="Pays de provenance" value="<?php echo $pays_provenance; ?>">
                                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="py-2">
                                            <h5 class="font-size-15">Détails de la cotation</h5>
                                                   ...
                                                   <tr>
                                                            <td>&nbsp;</td><td>&nbsp;</td>
                                                            <td><h4>Liste des articles</h4> <button id="ajout_article" data-toggle="modal" data-target="#myModal_article" style="margin:10px; " class="btn btn-info"><i class="fa fa-add"></i> Ajouter un article</button></td>
                                                        </tr>
                                                        <!-- end tr -->
	  ...
	  <form name="form_cotation" id="form_cotation" class="form-horizontal" action="#">
                ...
                <hr> <h4>Débours douane</h4>  <hr> 
                <input hidden type="text" class="form-control" id="total_fob_cfa" name="total_fob_cfa" placeholder="Fob Total" value="<?php echo $_SESSION['total_fob_cfa']; ?>">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input readonly type="text" class="form-control" id="dd_total" name="dd_total" placeholder="DD" value="<?php echo $_SESSION['total_dd'] ; ?>">
                            <label for="dd_total">DD </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input readonly type="text" class="form-control" id="rpi_total" name="rpi_total" placeholder="RPI" value="<?php echo $_SESSION['rpi'] ; ?>">
                            <label for="rpi_total">RPI </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input readonly value="20000" type="text" class="form-control" id="ts_total" name="ts_total" placeholder="TS">
                            <label for="ts_total">TS  </label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input readonly type="text" class="form-control" id="dt_total" name="dt_total" placeholder="D&T" value="<?php echo $_SESSION['dt'] ; ?>">
                            <label for="dt_total">D&T  </label>
                        </div>
                    </div>
                </div> 

                <hr> <h4>Frais transit</h4>  <hr> 
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input  type="text" class="form-control" id="fiche_assurance" name="fiche_assurance" placeholder="FICHE ASSURANCE" value="<?php echo $fiche_assurance; ?>" >
                            <label for="fiche_assurance">FICHE ASSURANCE  </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input readonly  type="text" class="form-control" id="agio" name="agio" placeholder="AGIO" value="<?php echo $agio ; ?>">
                            <label for="agio">AGIO  </label>
                        </div>
                    </div>
                    <div class="row">
                        <label for="floatingInput">Total frais transit : <b style="color:green;" id="total_frais_transit"></b></label>
                    </div>
                </div> 

                <hr> <h4>Débours divers</h4>  <hr> 
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="ouverture_dossier" name="ouverture_dossier"  placeholder="OUVERTURE DOSSIER" value="<?php echo $ouverture_dossier; ?>" >
                            <label for="floatingInput">OUVERTURE DOSSIER </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="acconage" name="acconage"  placeholder="ACCONAGE" value="<?php echo $acconage; ?>" >
                            <label for="floatingInput">ACCONAGE  </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="surestarie" name="surestarie"  placeholder="SURESTARIE" value="<?php echo $surestarie; ?>" >
                            <label for="floatingInput">SURESTARIE </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="echange_bl" name="echange_bl"  placeholder="ECHANGE BL" value="<?php echo $echange_bl; ?>" >
                            <label for="floatingInput">ECHANGE BL </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="caution" name="caution"  placeholder="CAUTION" value="<?php echo $caution; ?>" >
                            <label for="floatingInput">CAUTION  </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="livraison" name="livraison"  placeholder="LIVRAISON" value="<?php echo $livraison; ?>" >
                            <label for="floatingInput">LIVRAISON </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="ts_douane" name="ts_douane"  placeholder="TS DOUANE" value="<?php echo $ts_douane; ?>" >
                            <label for="floatingInput">PASSAGE DOUANE </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="retrait_documentaire" name="retrait_documentaire"  placeholder="RETRAIT DOCUMENTAIRE" value="<?php echo $retrait_documentaire; ?>" >
                            <label for="floatingInput">RETRAIT DOC</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="debours_divers" name="debours_divers"  placeholder="DEBOURS DIVERS" value="<?php echo $debours_divers; ?>" >
                            <label for="floatingInput">DEBOURS DIVERS</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="documentation_weeb" name="documentation_weeb"  placeholder="DOCUMENTATION WEEB" value="<?php echo $documentation_weeb; ?>" >
                            <label for="floatingInput">DOC WEEB </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="bsc" name="bsc"  placeholder="BSC" value="<?php echo $bsc; ?>" >
                            <label for="floatingInput">BSC  </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="certificat_phyto" name="certificat_phyto"  placeholder="CERTIFICAT PHYTO" value="<?php echo $certificat_phyto; ?>" >
                            <label for="floatingInput">CERTIFICAT PHYTO</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="api" name="api"  placeholder="API" value="<?php echo $api; ?>" >
                            <label for="floatingInput">API  </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="aiae" name="aiae"  placeholder="AI + AE" value="<?php echo $aiae; ?>" >
                            <label for="floatingInput">AI + AE</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="certificat_veterinaire" name="certificat_veterinaire"  placeholder="CERTIFICAT VETERINAIRE" value="<?php echo $certificat_veterinaire; ?>" >
                            <label for="floatingInput">CERTIF VETERINAIRE</label>
                        </div>
                    </div>
              
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="appurement_magasin" name="appurement_magasin"  placeholder="APPUREMENT MAGASIN" value="<?php echo $appurement_magasin; ?>" >
                            <label for="floatingInput">APPUREMENT MAG</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="magasinage" name="magasinage"  placeholder="MAGASINAGE" value="<?php echo $magasinage; ?>" >
                            <label for="floatingInput">MAGASINAGE</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="sortie_pc" name="sortie_pc"  placeholder="SORTIE PC" value="<?php echo $sortie_pc; ?>" >
                            <label for="floatingInput">SORTIE PC</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                    ...
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="escorte" name="escorte"  placeholder="ESCORTE" value="<?php echo $escorte; ?>" >
                            <label for="floatingInput">ESCORTE</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="manutention" name="manutention"  placeholder="MANUTENTION" value="<?php echo $manutention; ?>" >
                            <label for="floatingInput">MANUTENTION</label>
                        </div>
                    </div>
                    <div class="row">
                        <label for="floatingInput">Total débours divers : <b style="color:green;" id="total_debours_divers"></b></label>
                    </div>
                </div> 

                <hr> <h4>Prestation</h4>  <hr> 
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="had" name="had"  placeholder="TIRAGE DECLARATION" value="<?php echo $had; ?>" >
                            <label for="floatingInput">HAD </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-floating mb-3">
                            <input readonly type="text" class="form-control" id="bc" name="bc"  placeholder="TIRAGE DECLARATION" value="<?php echo 0.35*floatval($had); ?>" >
                            <label for="floatingInput">BC </label>
                        </div>
                    </div>
                    <div class="row">
                        <label for="floatingInput">Total intervention transit : <b style="color:green;" id="total_intervention_transit"></b></label>
                    </div>
                </div> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-floating mb-3">
                            <input readonly type="text" class="form-control" id="tva" name="tva" placeholder="TIRAGE DECLARATION" value="<?php echo 0.18*floatval($had); ?>">
                            <label for="floatingInput">TVA (18 %)</label>
                        </div>
                    </div>
                    <div class="row">
                        <label for="floatingInput">NET A PAYER : <b style="color:green;" id="net_a_payer"></b></label>
                    </div>
                </div> 
        ...
        <div class="row">&nbsp;</div>
                                                ...
                                                <div class="float-end">
                                                    ...
                                                    <a target="_blank" href="dossier_import/valider_cotation.php" class="btn btn-success me-1"><i class="fa fa-check"></i> Valider</a>
                                                    ...
                                                    <a target="_blank" href="dossier_import/soumettre_cotation.php" class="btn btn-success me-1"><i class="fa fa-share"></i> Soumettre</a>
                                                      <?php 
                                                        } 
                                                     ?>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="documentation" role="tabpanel">
                                        ...
                                        ?>
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div>
                                                                        <form id="form_drop" action="dossier_import/upload_doc.php" class="dropzone">
                                                                            <div class="fallback">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label for="r_dt">D&T</label>
                                                                <input class="form-control" type="text"  id="r_dt" value="<?php echo $r_dt; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_sydam">Sydam & Tirage</label>
                                                            <input class="form-control" type="text"  id="r_sydam" value="<?php echo $r_sydam; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_agio">AGIO (0,6%)</label>
                                                            <input readonly class="form-control" type="text"  id="r_agio" value="<?php echo $r_agio; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_ts_douane">Passage Douane</label>
                                                            <input class="form-control" type="text"  id="r_ts_douane" value="<?php echo $r_ts_douane; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_bsc">BSC</label>
                                                            <input class="form-control" type="text"  id="r_bsc" value="<?php echo $r_bsc; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_api">API</label>
                                                            <input class="form-control" type="text"  id="r_api" value="<?php echo $r_api; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_assurance">ASSURANCE</label>
                                                            <input class="form-control" type="text"  id="r_assurance" value="<?php echo $r_assurance; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_certificat_phyto">CERTIFICAT PHYTO</label>
                                                            <input class="form-control" type="text"  id="r_certificat_phyto" value="<?php echo $r_certificat_phyto; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_magasinage">MAGASINAGE</label>
                                                            <input class="form-control" type="text"  id="r_magasinage" value="<?php echo $r_magasinage; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_manutention">MANUTENTION</label>
                                                            <input class="form-control" type="text"  id="r_manutention" value="<?php echo $r_manutention; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_echange_bl">ECHANGE BL</label>
                                                            <input class="form-control" type="text"  id="r_echange_bl" value="<?php echo $r_echange_bl; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_acconage">Acconage</label>
                                                            <input class="form-control" type="text"  id="r_acconage" value="<?php echo $r_acconage; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_surestarie">Surestarie</label>
                                                            <input class="form-control" type="text"  id="r_surestarie" value="<?php echo $r_surestarie; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_caution">Caution</label>
                                                            <input class="form-control" type="text"  id="r_caution" value="<?php echo $r_caution; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_livraison">Livraison</label>
                                                            <input class="form-control" type="text"  id="r_livraison" value="<?php echo $r_livraison; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_transport_agent">Transport Agent</label>
                                                            <input class="form-control" type="text"  id="r_transport_agent" value="<?php echo $r_transport_agent; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_commission">Commission</label>
                                                            <input class="form-control" type="text"  id="r_commission" value="<?php echo $r_commission; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_retrait_documentaire">RETRAIT DOCUMENTAIRE</label>
                                                            <input class="form-control" type="text"  id="r_retrait_documentaire" value="<?php echo $r_retrait_documentaire; ?>" >
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="r_manifeste">AGENT NAS / MANIFESTE</label>
                                                            <input class="form-control" type="text"  id="r_manifeste" value="<?php echo $r_manifeste; ?>">
                                                    </div>
