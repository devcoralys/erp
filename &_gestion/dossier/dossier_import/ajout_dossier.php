...
$n=$con->query('SELECT * FROM dossier WHERE import=1 AND export=0 ');
$n->execute();
$nb=$n->rowcount();
$nb_new=$nb+1;
$num_dossier='S-IM000'.$nb_new.'/'.gmdate("Y");
...
$lib_trace="Creation dossier importation ".$type_transit_id."  N° ".$num_dossier." pour le client N° ".$client_id." ";
