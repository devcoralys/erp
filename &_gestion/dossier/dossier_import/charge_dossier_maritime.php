<?php
  ...
  var dataString = 'page_id_cons='+ page_id_cons;
    ...
    $requete=" SELECT * FROM dossier WHERE id_dossier!='' AND type_transit_id=1 AND import=1 AND export=0 ";
...
*/
    ...
    $req=" SELECT * FROM dossier WHERE id_dossier!='' AND type_transit_id=1 AND import=1 AND export=0 ";
