     ...
     <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <li><a href="../decaissement/decaissement.php" data-key="t-p-list" style="background-color:#251f75; color:#fff;"> Décaissement</a></li>
...
<!-- Left Sidebar End -->
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">decaissements</li>
                                    </ol>
                                    
                                </div>
                                <button id="ajout_decaissement" data-toggle="modal" data-target="#myModal_decaissement" style="margin:10px; " class="btn btn-danger"><i class="fa fa-">-</i> Effectuer un decaissement</button>
                            </div>
                        ...
                        <div class="card-body_" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    <label class="col-lg-4 control-label"><b>N° Réçu</b></label>
                                    <input type="text" class="form-control" name="recher_num_recu" id="recher_num_recu" placeholder="N° Réçu">
					            </div>

                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    <label class="col-lg-4 control-label"><b>N° Dossier</b></label>
                                    <input type="text" class="form-control" name="recher_num_dossier" id="recher_num_dossier" placeholder="N° Dossier">
					            </div>
 ...
 <!--
    ...
    <a href="excel/excel_decaissement.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_decaissement">
...
<!-- Modal decaissement -->
<!-- Modal -->
<div class="modal fade" id="myModal_decaissement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus_">-</i> Effectuer un decaissement</h4>
      </div>
	  ...
	  <form name="form_decaissement" id="form_decaissement" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_decaissement" name="date_decaissement" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                <label>N° du Réçu<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_recu_decaissement" name="num_recu_decaissement" />
            </div>		
            
            <div class="col-lg-8 col-xs-12">
                <label>N° du Dossier<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_dossier_decaissement" name="num_dossier_decaissement" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-8 col-xs-12">
                <label>Nom et Prénom(s) du bénéficiaire<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_decaissement" name="nom_client_decaissement" />
            </div>		
            
            <div class="col-lg-4 col-xs-12">
                <label>Montant<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_decaissement" name="montant_decaissement" />
            </div>	
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_decaissement" name="motif_decaissement"></textarea>
            </div>		
...
<div class="modal fade mod_pop" id="myModal_decaissement_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification decaissement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_decaissement_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_decaissement_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression decaissement</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_decaissement_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_decaissement_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal decaissement-->
