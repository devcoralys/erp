                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_autre_envoi" data-toggle="modal" data-target="#myModal_autre_envoi" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Nouvel envoi extérieur</button>
                        ...
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    ...
                                    <input type="text" class="form-control" name="recher_code_colis_autre_envoi" id="recher_code_colis_autre_envoi" placeholder="Code colis">
					            </div>
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_autre_envoi">
...
<!-- Modal caisse -->
<!-- Modal -->
<div class="modal fade" id="myModal_autre_envoi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_autre_envoi" id="form_autre_envoi" class="form-horizontal" action="#">
         ...
         <div class="col-lg-4 col-xs-12">
				 ...
				 <input readonly style="background-color:#f9f9f9; height:45px;" type="date" class="form-control" required id="date_autre_envoi" name="date_autre_envoi" value="<?php echo gmdate('Y-m-d'); ?>"  />
        </div>	
        ...
        <div class="col-lg-4 col-xs-12">
			...
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="expediteur_autre_envoi" name="expediteur_autre_envoi" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>N° CNI Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="num_cni_expediteur_autre_envoi" name="num_cni_expediteur_autre_envoi" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_expediteur_autre_envoi" name="tel_expediteur_autre_envoi" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destinataire [Nom et Prénom(s)]<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destinataire_autre_envoi" name="destinataire_autre_envoi" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destination<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destination_autre_envoi" name="destination_autre_envoi" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Destinataire<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_destinataire_autre_envoi" name="tel_destinataire_autre_envoi" value="" />
        </div>	
        ...
        <div class="col-lg-12 col-xs-12">
				 ...
				 <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="adresse_recuperation_autre_envoi" name="adresse_recuperation_autre_envoi" value=""  />
            </div>		
		</div>
        <div class="row">
            <div class="col-lg-8 col-xs-12">
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="button" id="envoie_autre_envoi" class="btn button_valid"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
