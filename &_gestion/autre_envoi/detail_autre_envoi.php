...
$inf1=$con->prepare('SELECT * FROM autre_envoi WHERE id_autre_envoi=:A');
$inf1->execute(array('A'=>$_SESSION['id_autre_envoi']));
$info1=$inf1->fetch();

$lib_trace="Ouverture autre envoi N* <b>".$info1['num_autre_envoi']."</b> ";
...
<!-- Left Sidebar End -->
					    ...
					    <div class="col-lg-12">
					        <div class="panel">
					            <div class="panel-heading" style="background-color:#a44b73; background-color:#f7f8fa;">
					                <h3 class="panel-title"  style="text-align:center; color:#3e58ff;">LISTE DE COLISAGE <b>N° <?php echo $num_autre_envoi; ?></b></h3><br>
        ...
        <?php if($etat_autre_envoi==0){ ?>
        <button id="terminer" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Terminer</button>
        <button id="ajout_colis_autre_envoi" data-toggle="modal" data-target="#myModal_colis_autre_envoi" style="margin:10px; right:10px; position:absolute; margin-bottom:10px;" class="btn btn-purple right"><i class="fa fa-plus"></i> Ajouter une ligne</button>
        ...
        <p style="border-bottom:1px solid #E3E3E3">&nbsp;&nbsp;</p>
                ...
                <?php if($etat_autre_envoi>=1){ ?>
                <a href="../exportation/pdf/pdf_autre_envoi.php?id_autre_envoi=<?php echo $_SESSION['id_autre_envoi']; ?>" target="_blank" style="font-size:28px; font-weight:600; color: black;" title="Cliquez pour générer la fiche">
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row voir aff_colis_autre_envoi">
...
<!-- Modal -->
<div class="modal fade" id="myModal_colis_autre_envoi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_colis_autre_envoi" id="form_colis_autre_envoi" class="form-horizontal" action="#">
		
		<div class="row">
        
            <div class="col-lg-3 col-xs-12">
                <label>Nbre Colis<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="nbre_colis_autre_envoi" name="nbre_colis_autre_envoi" placeholder="Nombre Colis" />
                <input style="background-color:#f9f9f9; height:45px;" type="hidden" class="form-control" required value="<?php echo $time_autre_envoi; ?>" id="time_autre_envoi" />
            </div>	
            <div class="col-lg-3 col-xs-12">
            ...
            <div class="col-lg-6 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="nature_colis_autre_envoi" name="nature_colis_autre_envoi" placeholder="Nature du colis"  />
            </div>
            <div class="col-lg-4 col-xs-12">
                <label>Poids<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="poids_colis_autre_envoi" name="poids_colis_autre_envoi" placeholder="Poids"  />
            </div>
            <div class="col-lg-4 col-xs-12">
                <label>Prix / Kilo<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="pu_colis_autre_envoi" name="pu_colis_autre_envoi" placeholder="Prix/Kg"  />
            </div>	
            <div class="col-lg-4 col-xs-12">
                <label>Emballage<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="emballage_colis_autre_envoi" name="emballage_colis_autre_envoi" placeholder="Coût de l'emballage"  />
            </div>	
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix du colis : <span class="semi_aste" id="prix_total_colis_autre_envoi" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-3 col-xs-12">
                   &nbsp;
                </div>  
        ...
        <div class="col-lg-12 col-xs-12 msg_error"></div>
		 ...
		 <button type="submit" id="envoie_colis_autre_envoi" class="btn"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
		...
		<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="valeur_colis_autre_envoi" name="valeur_colis_autre_envoi" placeholder="Saisir le prix total de cet envoi"  />
                </div>	
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix de la marchandise : <span class="semi_aste" id="prix_final_colis_autre_envoi" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-6 col-xs-12">
...
<div class="modal fade mod_pop" id="myModal_colis_autre_envoi_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification colis_autre_envoi</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_colis_autre_envoi_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_colis_autre_envoi_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_colis_autre_envoi_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_colis_autre_envoi_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_terminer">Voulez-vous vraiment clôturer la saisie de ce autre_envoi ?</div>
		</div>
