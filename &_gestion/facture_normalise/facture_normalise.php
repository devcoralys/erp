...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | Facture normalisée</title>
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <li><a href="../facture_normalise/facture_normalise.php" data-key="t-p-list" style="background-color:#251f75; color:#fff;">Factures normalisées</a></li>
                </ul>
            </li>
            <?php } ?>
...
<!-- Left Sidebar End -->
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">facture normalisée</li>
                                    </ol>
                                    
                                </div>
                                <button id="ajout_facture_normalise" data-toggle="modal" data-target="#myModal_facture_normalise" style="margin:10px; " class="btn btn-success"><i class="fa fa-">+</i> Enregistrer une facture normalisée</button>
                            </div>
 ...
 <!--
    ...
    <a href="excel/excel_facture_normalise.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_facture_normalise">
...
<!-- Modal facture_normalise -->
<!-- Modal -->
<div class="modal fade" id="myModal_facture_normalise" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus_">+</i> Enregistrer une facture normalisée</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_facture_normalise" id="form_facture_normalise" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_facture_normalise" name="date_facture_normalise" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                <label>N° de la facture<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_recu_facture_normalise" name="num_recu_facture_normalise" />
            </div>		
            
            <div class="col-lg-8 col-xs-12">
                <label>N° du Dossier<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_dossier_facture_normalise" name="num_dossier_facture_normalise" />
            </div>	
		...
		<div class="row">
            <div class="col-lg-6 col-xs-12">
                <label>Nom du client<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="nom_client_facture_normalise" name="nom_client_facture_normalise" />
            </div>		
            
            <div class="col-lg-3 col-xs-12">
                <label>Montant<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_facture_normalise" name="montant_facture_normalise" />
            </div>
		...
		<div class="row">
            <div class="col-lg-12 col-xs-12">
                <label>Demandeur<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="demandeur_facture_normalise" name="demandeur_facture_normalise" />
            </div>		
		</div>
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                <label>Observation<span class="semi_aste">*</span></label>
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_facture_normalise" name="motif_facture_normalise"></textarea>
            </div>		
...
<div class="modal fade mod_pop" id="myModal_facture_normalise_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification facture_normalise</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_facture_normalise_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_facture_normalise_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression facture_normalise</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_facture_normalise_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_facture_normalise_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal facture_normalise-->
