...
$_SESSION['id_groupage']=$_GET['id_groupage'];
...
$inf1=$con->prepare('SELECT * FROM groupage WHERE id_groupage=:A');
$inf1->execute(array('A'=>$_SESSION['id_groupage']));
$info1=$inf1->fetch();

$lib_trace="Ouverture groupage N* <b>".$info1['num_groupage']."</b> ";
...
$inf->execute(array('A'=>$_SESSION['id_groupage']));
$info=$inf->fetch();

$num_groupage=$info['num_groupage'];
$date_groupage=date("d/m/Y", strtotime($info['date_groupage']));
$expediteur_groupage=stripslashes($info['expediteur_groupage']);
if($info['num_cni_expediteur_groupage']!='')
{
$num_cni_expediteur_groupage=stripslashes($info['num_cni_expediteur_groupage']);
}
else
{
$num_cni_expediteur_groupage='<b style="color:red;">Aucune CNI Fournie</b>';    
}


$tel_expediteur_groupage=stripslashes($info['tel_expediteur_groupage']);
$code_colis_groupage=stripslashes($info['num_groupage']);
$destinataire_groupage=stripslashes($info['destinataire_groupage']);
$destination_groupage=stripslashes($info['destination_groupage']);
$tel_destinataire_groupage=stripslashes($info['tel_destinataire_groupage']);
$etat_groupage=$info['etat_groupage'];
$time_groupage=$info['time_groupage'];
$valeur_colis=$info['valeur_colis'];
$montant_assurance=$info['montant_assurance'];

$_SESSION['time']=$time_groupage;
?>
<!doctype html>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | Groupage</title>
...
<div data-simplebar class="sidebar-menu-scroll">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="../groupage/groupage.php" style="background-color:#251f75; color:#fff;">
...
<!-- Left Sidebar End -->
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="chargement_" style="text-align:center; margin-top:70px"></div>
                          ...
                          $bes=$con->prepare('SELECT * FROM groupage WHERE id_groupage=:A');
                          $bes->execute(array('A'=>$_SESSION['id_groupage']));
                          $ibes=$bes->fetch();

                       
                          $etat_groupage = $ibes['etat_groupage'];
					    ...
					    <div class="col-lg-12">
					        <div class="panel">
					            <div class="panel-heading" style="background-color:#a44b73; background-color:#f7f8fa;">
					                <h3 class="panel-title"  style="text-align:center; color:#3e58ff;">LISTE DE COLISAGE <b>N° <?php echo $num_groupage; ?></b></h3><br>
                                    <p style="text-align:center; color:#3e58ff;">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <b>Date : <?php echo $date_groupage; ?> </b><br>
                                                <b>Expéditeur : </b><label><?php echo $expediteur_groupage; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>N° CNI : </b><label><?php echo $num_cni_expediteur_groupage; ?></label><br>
                                                <b>Téléphone Expéditeur : </b><label><?php echo $tel_expediteur_groupage; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>Code Colis : <?php echo $code_colis_groupage; ?> </b><br>
                                                <b>Destinataire : </b><label><?php echo $destinataire_groupage; ?></label><br>
                                            </div>
                                            <div class="col-md-3">
                                                <b>Destination : </b><label><?php echo $destination_groupage; ?></label><br>
                                                <b>Téléphone Destinataire : </b><label><?php echo $tel_destinataire_groupage; ?></label><br>
                                            </div>
                                        </div>
                                    </p>
					            </div>
        ...
        <?php if($etat_groupage==0){ ?>
        <button id="terminer" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Terminer</button>
        <button id="ajout_colis" data-toggle="modal" data-target="#myModal_colis" style="margin:10px; right:10px; position:absolute; margin-bottom:10px;" class="btn btn-purple right"><i class="fa fa-plus"></i> Ajouter une ligne</button>
        ...
        <p style="border-bottom:1px solid #E3E3E3">&nbsp;&nbsp;</p>
                ...
                <?php if($etat_groupage>=1){ ?>
                <a href="../exportation/pdf/pdf_groupage.php?id_groupage=<?php echo $_SESSION['id_groupage']; ?>" target="_blank" style="font-size:28px; font-weight:600; color: black;" title="Cliquez pour générer la fiche">
...
<!-- Modal colis -->
<!-- Modal -->
<div class="modal fade" id="myModal_colis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_colis" id="form_colis" class="form-horizontal" action="#">
		
		<div class="row">
        
            <div class="col-lg-3 col-xs-12">
                <label>Nbre Colis<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="nbre_colis" name="nbre_colis" placeholder="Nombre Colis" />
                <input style="background-color:#f9f9f9; height:45px;" type="hidden" class="form-control" required value="<?php echo $time_groupage; ?>" id="time_groupage" />
            </div>	
            <div class="col-lg-3 col-xs-12">
            ...
            <div class="col-lg-6 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="nature_colis" name="nature_colis" placeholder="Nature du colis"  />
            </div>
            <div class="col-lg-3 col-xs-12">
                <label>Poids<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="poids_colis" name="poids_colis" placeholder="Poids"  />
            </div>
            <div class="col-lg-3 col-xs-12">
                <label>Prix / Kilo<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="pu_colis" name="pu_colis" placeholder="Prix/Kg"  />
            </div>	
            <div class="col-lg-3 col-xs-12">
                <label>Emballage<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="emballage_colis" name="emballage_colis" placeholder="Coût de l'emballage"  />
            </div>
            
            <div class="col-lg-3 col-xs-12">
                <label>Type d'emballage<span class="semi_aste">*</span></label>
                    <select style="background-color:#f9f9f9; height:45px;" class="form-control" required id="type_emballage_colis" name="type_emballage_colis">
                        <option value="1">Carton</option>
                        <option value="2">Sachet</option>
                        <option value="3">Bidon</option>
                    </select>
            </div>
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix du colis : <span class="semi_aste" id="prix_total_colis" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-3 col-xs-12">
                   &nbsp;
                </div>  
        ...
        <div class="col-lg-12 col-xs-12 msg_error"></div>
		 ...
		 <button type="submit" id="envoie_colis" class="btn"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
		...
		<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" required id="valeur_colis" name="valeur_colis" placeholder="Saisir le prix total de cet envoi"  />
                </div>	
                <div class="col-lg-6 col-xs-12 bloc_assurance">
                    <label>Montant assurance (en FCFA)</label>
                    <input style="background-color:#f9f9f9; height:45px;" type="number" class="form-control" id="montant_assurance" readonly>
                </div>
            </div>
            ...
            <div class="row">	
                ...
                <div class="col-lg-6 col-xs-12">
                    <label style="margin-top:37px;">Prix de la marchandise : <span class="semi_aste" id="prix_final_colis" style="color:grey; font-weight:bold;font-size:23px;">0 FCFA</span></label>
                </div>  
                <div class="col-lg-6 col-xs-12">
...
<div class="modal fade mod_pop" id="myModal_colis_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification colis</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_colis_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_colis_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="submit" id="submit_colis_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_terminer">Voulez-vous vraiment clôturer la saisie de ce groupage ?</div>
		</div>
