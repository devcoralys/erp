                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_groupage" data-toggle="modal" data-target="#myModal_groupage" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Nouveau groupage</button>
                        ...
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    ...
                                    <input type="text" class="form-control" name="recher_code_colis" id="recher_code_colis" placeholder="Code colis">
					            </div>
    ...
    <a href="excel/excel_caisse.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_groupage">
...
<!-- Modal caisse -->
<!-- Modal -->
<div class="modal fade" id="myModal_groupage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <form name="form_groupage" id="form_groupage" class="form-horizontal" action="#">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-12">
            <label>Agence<span class="semi_aste">*</span></label>
            <select class="form-control" data-trigger id="agence_id">
              <option value="">Choisir une agence</option>
					                                  <?php
	                                                 $rem=$con->prepare("SELECT * FROM agence ORDER BY lib_agence ASC");
                                                     $rem->execute();
                                                     while($rom=$rem->fetch())
	                                                 {
	                                                 ?>
        <option value="<?php echo ''.$rom['id_agence'].''; ?>"><?php echo ' ('.$rom['code_agence'].')  '.stripslashes($rom['lib_agence']).' '; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>          </div>		
         ...
         <div class="col-lg-4 col-xs-12">
				 ...
				 <input readonly style="background-color:#f9f9f9; height:45px;" type="date" class="form-control" required id="date_groupage" name="date_groupage" value="<?php echo gmdate('Y-m-d'); ?>"  />
        </div>	
        ...
        <div class="col-lg-4 col-xs-12">
			...
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="expediteur_groupage" name="expediteur_groupage" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Type de Pièce Expéditeur<span class="semi_aste">*</span></label>
            <select class="form-control" data-trigger id="type_piece_id">
              <option value="">Choisir le type de pièce</option>
					                                  <?php
	                                                 $rem=$con->prepare("SELECT * FROM type_piece ORDER BY lib_type_piece ASC");
                                                     $rem->execute();
                                                     while($rom=$rem->fetch())
	                                                 {
	                                                 ?>
        <option value="<?php echo''.$rom['id_type_piece'].''; ?>"><?php echo ' '.stripslashes($rom['lib_type_piece']).' '; ?></option>
                                                     <?php
	                                                 }
	                                                 ?>
					                            </select>        
        ...
        <div class="col-lg-4 col-xs-12">
            <label>N° Pièce Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="num_cni_expediteur_groupage" name="num_cni_expediteur_groupage" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Expéditeur<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_expediteur_groupage" name="tel_expediteur_groupage" value="" />
        </div>	
        ...
        <div class="col-lg-4 col-xs-12">
			...
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destinataire_groupage" name="destinataire_groupage" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Destination<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="destination_groupage" name="destination_groupage" value="" />
        </div>	

        <div class="col-lg-4 col-xs-12">
            <label>Téléphone Destinataire<span class="semi_aste">*</span></label>
			<input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_destinataire_groupage" name="tel_destinataire_groupage" value="" />
        </div>	
        ...
        <div class="col-lg-12 col-xs-12">
				 ...
				 <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="adresse_recuperation_groupage" name="adresse_recuperation_groupage" value="1 Avenue Louis Blériot 93120 La Courneuve Porte A26"  />
            </div>		
		</div>
        <div class="row">
            <div class="col-lg-8 col-xs-12">
                    <label>Nom<span class="semi_aste">*</span></label>
                    <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="nom_recuperateur" name="nom_recuperateur" value="ADJI YORO"  />
            </div>	
            <div class="col-lg-4 col-xs-12">
            <label>Téléphone<span class="semi_aste">*</span></label>
                    <input style="background-color:#f9f9f9; height:45px;" type="text" class="form-control" required id="tel_recuperateur" name="tel_recuperateur" value="+33777444001"  />
            </div>
        </div>

        <div class="row">&nbsp;</div>

         <!-- Ajout de la case à cocher pour la livraison -->
         <div class="row">
            <div class="col-lg-12 col-xs-12">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="livraison_checkbox">
                <label class="form-check-label" for="livraison_checkbox">
                  À livrer
                </label>
              </div>
            </div>
		 ...
		 <button type="submit" id="envoie_groupage" class="btn button_valid"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
