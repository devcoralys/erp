...
$('#ajout_suivi_general').live('click', function(){
	$('#myModal_suivi_general').modal('show');
});
$('#send_report').live('click',function(){
	...
	var num_suivi_general_rapport=$("#num_suivi_general_rapport").val();
	var date_suivi_general_rapport=$("#date_suivi_general_rapport").val();
	...
	"&num_suivi_general_rapport="+num_suivi_general_rapport+
	"&date_suivi_general_rapport="+date_suivi_general_rapport+
