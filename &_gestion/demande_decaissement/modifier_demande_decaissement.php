...
include('../../connex.php');
    ...
    $id_encaissement_mod=$_GET['id_enc_mod'];
    
    $_SESSION['id_enc_mod']=$id_encaissement_mod;
    
    $enc=$con->prepare('SELECT * FROM encaissement WHERE id_encaissement=:A');
    $enc->execute(array('A'=>$id_encaissement_mod));

    $inf_enc=$enc->fetch();

    $date_encaissement=$inf_enc["date_encaissement"];
    $num_recu_encaissement=$inf_enc["num_recu_encaissement"];
    $num_dossier_encaissement=$inf_enc["num_dossier_encaissement"];
    $montant_encaissement=floatval($inf_enc["montant_encaissement"]);
    $mode_reglement_encaissement=$inf_enc["mode_reglement_encaissement"];
    $motif_encaissement=$inf_enc["motif_encaissement"];
    ...
    <a href="excel/excel_declaration.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_encaissement_modifier">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_encaissement" name="date_encaissement" value="<?php echo $inf_enc["date_encaissement"]; ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_recu_encaissement" name="num_recu_encaissement" value="<?php echo $inf_enc["num_recu_encaissement"]; ?>"  />
            </div>		
            
            <div class="col-lg-8 col-xs-12">
                <label>N° Dossier<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="num_dossier_encaissement" name="num_dossier_encaissement" value="<?php echo $inf_enc["num_dossier_encaissement"]; ?>" />
            </div>	
		...
		<div class="row">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="nom_client_encaissement" name="nom_client_encaissement" placeholder="nom_client" value="<?php echo $inf_enc["nom_client_encaissement"]; ?>" >
                            <label for="floatingInput">Nom et Prénom(s) du client</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input  type="number" class="form-control" id="montant_encaissement" name="montant_encaissement" placeholder="montant" value="<?php echo floatval($inf_enc["montant_encaissement"]); ?>" >
                    ...
                    <div class="col-md-4">
                           ...
                           <select id="mode_reglement" name="mode_reglement" class="form-select" style="margin:1px;">
                                ...
                                <option value="cheque" <?php if($inf_enc["mode_reglement_encaissement"]=="cheque"){ echo ' selected '; } ?>>Chèque</option>
                                <option value="espece" <?php if($inf_enc["mode_reglement_encaissement"]=="espece"){ echo ' selected '; } ?>>Espèce</option>
                                <option value="virement" <?php if($inf_enc["mode_reglement_encaissement"]=="virement"){ echo ' selected '; } ?>>Virement</option>
                            </select>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color: rgb(249, 249, 249); color: green; font-weight: bold; height: 200px; --darkreader-inline-bgcolor: #1b1e1f; --darkreader-inline-color: #72ff72;" type="text" class="form-control" required="" id="motif_encaissement" name="motif_encaissement" data-darkreader-inline-bgcolor="" data-darkreader-inline-color=""><?php echo $inf_enc["motif_encaissement"]; ?></textarea>
            </div>		
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="submit" id="envoie_encaissement_mod" class="btn button_valid"><i class="fa fa-check"></i> Enregistrer les modifications</button>&nbsp;&nbsp;
