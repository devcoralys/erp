...
$req=$con->prepare("UPDATE demande_decaissement SET etat_demande=1, secur_accepte_demande_decaissement=:A, date_accepte_demande_decaissement=:B WHERE id_demande_decaissement=:C ");
...
$lib_trace="Acceptation de la demande N° <b>".$_SESSION['id_accepte']."</b>  ";
...
$iedc=$sedc->fetch();
$util_accepte=$iedc['nom_utilisateur'];
...
$mail->Subject = "ACCEPTATION DECAISSEMENT";
$mail->Body = "
    Demande de decaissement du montant de <b>".$montant."</b> pour <b>".$motif."</b> emise par <b>".$demandeur."</b> acceptee par <b>".$util_accepte."</b>.
    Veuillez cliquer sur <a href='https://app.stt.ci'><button class='btn btn-success'>CE LIEN</button></a> 
    Pour effectuer le decaissement.
";
