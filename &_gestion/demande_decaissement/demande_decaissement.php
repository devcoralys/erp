...
<div data-simplebar class="sidebar-menu-scroll">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="../demande_decaissement/demande_decaissement.php" style="background-color:#251f75; color:#fff;">
...
<!-- Left Sidebar End -->
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">demande_decaissements</li>
                                    </ol>
                                    
                                </div>
                                <button id="ajout_demande_decaissement" data-toggle="modal" data-target="#myModal_demande_decaissement" style="margin:10px; " class="btn btn-success"><i class="fa fa-">+</i> Demander un décaissement</button>
                            </div>
                    ...
                    <!-- end page title -->
                        ...
                        <!--Formulaire de recherche-->
                          <div class="card_">
                        <div class="card-body_" style="position: relative;">
                            ...
                            <div class="row">
					            ...
					            <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
					                <label class="col-lg-4 control-label"><b>Etat de la demande</b></label>
			                                    <select class="form-control" data-trigger id="recher_etat">
                                <option value="">--Choisir--</option>
                                <option value="0">Non défini</option>
                                <option value="1">Acceptée</option>
                                <option value="2">Réfusée</option>
                                <option value="3">Décaissée</option>
					                            </select>
					            </div>
 ...
 <!--
    ...
    <a href="excel/excel_demande_decaissement.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_demande_decaissement">
...
<!-- Modal demande_decaissement -->
<!-- Modal -->
<div class="modal fade" id="myModal_demande_decaissement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus_">+</i> Demander un décaissement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_demande_decaissement" id="form_demande_decaissement" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_demande_decaissement" name="date_demande_decaissement" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="number" class="form-control" required id="montant_demande_decaissement" name="montant_demande_decaissement" />
            </div>
            ...
            <div class="col-lg-4 col-xs-12">
                <label>Mode Règlement<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="mode_reglement">
                    <option value="">Choisir</option>
                    <option value="Orange Money"><img src="../img_decaisse/om.png"/> Orange Money</option>
            ...
            <div class="col-lg-4 col-xs-12">
                <label>Affectation<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="affectation" required>
                    <option value="">Choisir</option>
                    <option value="import">Import</option>
                    <option value="export">Export</option>
                    <option value="groupage">Groupage</option>
                    <option value="autre_envoi">Autre Envoi</option>
                    <option value="charge_fournisseur">Charge Fournisseur</option>
			    </select>
            </div>
            
            <div class="import col-lg-12 col-xs-12">
                <label>N° du dossier import<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="num_dossier_import">
                    <option value="">---Choisir---</option>
                        <?php
                        $red=$con->prepare("SELECT * FROM dossier ORDER BY num_dossier ASC");
                        $red->execute();
                        while($ro=$red->fetch())
                        {
                        ?>
                        <option value="<?php echo''.$ro['id_dossier'].''; ?>"><?php echo ''.stripslashes($ro['num_dossier']).'' ; ?></option>
                        <?php
                        }
                        ?>
			    </select>
            ...
            <div class="export col-lg-12 col-xs-12">
                <label>N° du dossier export<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="num_dossier_export">
                    <option value="">---Choisir---</option>
                        <?php
                        $red=$con->prepare("SELECT * FROM dossier_exp ORDER BY num_dossier ASC");
                        $red->execute();
                        while($ro=$red->fetch())
                        {
                        ?>
            ...
            <div class="groupage col-lg-12 col-xs-12">
                <label>N° du groupage<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="num_groupage">
                    <option value="">---Choisir---</option>
                        <?php
                        $red=$con->prepare("SELECT * FROM groupage ORDER BY num_groupage ASC");
                        $red->execute();
                        while($ro=$red->fetch())
                        {
                        ?>
                        <option value="<?php echo''.$ro['id_groupage'].''; ?>"><?php echo ''.stripslashes($ro['num_groupage']).'' ; ?></option>
                        <?php
                        }
                        ?>
			    </select>
            ...
            <div class="autre_envoi col-lg-12 col-xs-12">
                <label>N° Autre Envoi<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="num_autre_envoi">
                    <option value="">---Choisir---</option>
                        <?php
                        $red=$con->prepare("SELECT * FROM autre_envoi ORDER BY num_autre_envoi ASC");
                        $red->execute();
                        while($ro=$red->fetch())
                        {
                        ?>
                        <option value="<?php echo''.$ro['id_autre_envoi'].''; ?>"><?php echo ''.stripslashes($ro['num_autre_envoi']).'' ; ?></option>
                        <?php
                        }
                        ?>
			    </select>
            ...
            <div class="charge_fournisseur col-lg-12 col-xs-12">
                <label>Code Fournisseur<span class="semi_aste">*</span></label>
               	<select class="form-control" data-trigger id="code_fournisseur">
                    <option value="">---Choisir---</option>
                        <?php
                        $red=$con->prepare("SELECT * FROM fournisseur ORDER BY code_fournisseur ASC");
                        $red->execute();
                        while($ro=$red->fetch())
                        {
                        ?>
                        <option value="<?php echo''.$ro['id_fournisseur'].''; ?>"><?php echo ''.stripslashes($ro['num_fournisseur']).'' ; ?></option>
                        <?php
                        }
                        ?>
			    </select>
		...
		<div class="row">
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <textarea style="background-color:#f9f9f9; color:green; font-weight:bold; height:200px;" type="text" class="form-control" required id="motif_demande_decaissement" name="motif_demande_decaissement"></textarea>
            </div>		
...
<div class="modal fade mod_pop" id="myModal_demande_decaissement_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification demande_decaissement</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_demande_decaissement_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_demande_decaissement_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression demande_decaissement</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_demande_decaissement_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_demande_decaissement_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal demande_decaissement-->
    ...
    $(document).ready(function() {
        ...
        <script>
                ...
                {
                  value: 'Orange Money',
                  label: '<img src="../img_decaisse/om.png" style="height:30px; width:auto;" /> Orange Money',
                  id: 1
                },
                {
                value: 'MTN Money',
                  label: '<img src="../img_decaisse/momo.png" style="height:30px; width:auto;" /> MTN Money',
                  id: 2
                },
                {
                value: 'Flooz',
                  label: '<img src="../img_decaisse/flooz.png" style="height:30px; width:auto;" /> Flooz',
                  id: 3
                },
                {
                value: 'Wave',
                  label: '<img src="../img_decaisse/wave.png" style="height:30px; width:auto;" /> Wave',
                  id: 4
                },
                {
                value: 'Cash',
                  label: '<img src="../img_decaisse/cash.png" style="height:30px; width:auto;" /> Cash',
                  id: 5
                }
                ]
                
                const element = document.querySelector('#mode_reglement');
