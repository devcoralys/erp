...
$req=$con->prepare("UPDATE demande_decaissement SET etat_demande=2, secur_refuse_demande_decaissement=:A, date_refuse_demande_decaissement=:B WHERE id_demande_decaissement=:C ");
...
$lib_trace="Refus de la demande N° <b>".$_SESSION['id_accepte']."</b>  ";
...
$mail->Subject = "REFUS DECAISSEMENT";
$mail->Body = "
    Demande de decaissement du montant de ".$montant." pour ".$motif." emise par ".$demandeur." refusee.
