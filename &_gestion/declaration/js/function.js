...
$('#form_declaration').live('submit',function(){
	...
	$.ajax({
	type: "POST",
	url: "declaration/ajout_declaration.php",
	data: 
...
$('#recher_date_debut').on('keyup',function(){
	...
	var recher_num_declaration=$("#recher_num_declaration").val();
	var recher_reference=$("#recher_reference").val();
...
$('#recher_num_declaration').on('keyup',function(){
...
$('#recher_reference').on('keyup',function(){
...
function change_page_declaration(page_id){
