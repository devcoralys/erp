                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_declaration" data-toggle="modal" data-target="#myModal_declaration" style="margin:10px; " class="btn btn-primary"><i class="fa fa-bullhorn"></i> Effectuer une declaration</button>
                            </div>
                        ...
                        <div class="card-body_" style="position: relative;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    <label class="col-lg-4 control-label"><b>N° Déclaration</b></label>
                                    <input type="text" class="form-control" name="recher_num_declaration" id="recher_num_declaration" placeholder="N° Déclaration">
					            </div>

                                <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                    <label class="col-lg-4 control-label"><b>Référence</b></label>
                                    <input type="text" class="form-control" name="recher_reference" id="recher_reference" placeholder="Référence">
					            </div>
    ...
    <a href="excel/excel_declaration.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_declaration">
	  ...
	  <form name="form_declaration" id="form_declaration" class="form-horizontal" action="#">
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="date" class="form-control" required id="date_declaration" name="date_declaration" value="<?php echo gmdate('Y-m-d'); ?>" />
            </div>		
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                ...
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="reference_declaration" name="reference_declaration" />
            </div>		
            
            <div class="col-lg-8 col-xs-12">
                <label>Client<span class="semi_aste">*</span></label>
                <input style="background-color:#f9f9f9; height:45px; color:green; font-weight:bold;" type="text" class="form-control" required id="client_declaration" name="client_declaration" />
            </div>	
		...
		<div class="row">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="regime_declaration" name="regime_declaration" placeholder="REGIME">
                            <label for="floatingInput">REGIME</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input  type="text" class="form-control" id="bureau_declaration" name="bureau_declaration" placeholder="BUREAU">
                            <label for="floatingInput">BUREAU</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="num_declaration" name="num_declaration" placeholder="N° DECLARATION">
                            <label for="floatingInput">N° DECLARATION </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="num_liquidation_declaration" name="num_liquidation_declaration" placeholder="N° LIQUIDATION">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="dt_declaration" name="dt_declaration" placeholder="D&T" value="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="agio_declaration" name="agio_declaration" placeholder="AGIO" value="0">
                            <label for="floatingInput">AGIO </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="tirage_declaration" name="tirage_declaration" placeholder="TIRAGE" value="0">
                            <label for="floatingInput">TIRAGE</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="ouverture_declaration" name="ouverture_declaration" placeholder="OUVERTURE" value="0">
                            <label for="floatingInput">OUVERTURE</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="fdi_declaration" name="fdi_declaration" placeholder="FDI + RFCV" value="10000">
                            <label for="floatingInput">FDI + RFCV</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="assurance_declaration" name="assurance_declaration" placeholder="ASSURANCE" value="0">
                            <label for="floatingInput">ASSURANCE</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="num_quittance_declaration" name="num_quittance_declaration" placeholder="QUITTANCE N°">
                            <label for="floatingInput">QUITTANCE N°</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="conteneur_declaration" name="conteneur_declaration" placeholder="CONTENEUR">
                            <label for="floatingInput">CONTENEUR</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="bsc_declaration" name="bsc_declaration" placeholder="DIVERS/BSC" value="0">
                            <label for="floatingInput">DIVERS/BSC</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="lta_declaration" name="lta_declaration" placeholder="LTA">
                            <label for="floatingInput">LTA/BL</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="poids_declaration" name="poids_declaration" placeholder="POIDS" value="0">
		...
		<div class="row">
            ...
            <div class="col-lg-6 col-xs-12">
                <label>Montant Total : <span id="aff_total_declaration" class="semi_aste" style="font-weight:bold; font-size:23px; color:green;">0</span> FCFA</label> 
            </div>	
        ...
        <div class="row">&nbsp;</div>
		 ...
		 <button type="submit" id="envoie_declaration" class="btn button_valid"><i class="fa fa-check"></i> Valider</button>&nbsp;&nbsp;
