...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('../titre_ent_1.php'); ?> | Rapport journalier</title>
     ...
     <?php if($_SESSION['acces_autre_envoi_france']==1 ){ ?>
            ...
            <li style="background-color:#251f75; color:#fff;">
                <a href="../rapport/rapport.php" class="active">
                    ...
                    <span style="color:#fff;" class="menu-item">Rapport journalier</span>
                </a>
            </li>
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Rapport journalier</li>
                                    </ol>
                                    
                                </div>
                                <button style="margin:10px; color:red; " class="btn btn-"><i class="fa fa-comment"></i> Saisie du rapport en cours...</button>
                            </div>
                          ...
                          <div class="col-xl-9">
                                <div class="card">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        <h4 class="card-title">Veuillez remplir le formulaire SVP</h4>
                                    </div><!-- end card header -->
                                    <div class="card-body">
                                        
                                        <div class="row">
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="date" class="form-control" id="date_rapport" placeholder="" value="<?php echo gmdate('Y-m-d'); ?>">
                                                <label for="floatingInput">Date</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-3">
                                                <input type="text" class="form-control" id="num_dossier_rapport" placeholder="" value="">
                                                <label for="floatingInput">Dossier N°</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-7">
                                                <input type="text" class="form-control" id="nom_client_rapport" placeholder="" value="">
                                        ...
                                        <div class="row">
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="number" class="form-control" id="montant_cotation_rapport" placeholder="" value="">
                                                <label for="floatingInput">Montant cotation</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="number" class="form-control" id="montant_decaisse_rapport" placeholder="" value="">
                                                <label for="floatingInput">Montant décaissé</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="number" class="form-control" id="montant_restant_rapport" placeholder="" value="">
                                                <label for="floatingInput">Montant restant</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-4">
                                                <input type="text" class="form-control" id="num_declaration_rapport" placeholder="" value="">
                                                <label for="floatingInput">N° Déclaration</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="date" class="form-control" id="date_declaration_rapport" placeholder="" value="">
                                                <label for="floatingInput">Date déclaration</label>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="form-floating mb-3 col-md-8">
                                                <input type="text" class="form-control" id="avancement_dossier_rapport" placeholder="" value="">
                                                <label for="floatingInput">Avancement du dossier</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="date" class="form-control" id="date_livraison_rapport" placeholder="" value="">
                                                <label for="floatingInput">Date livraison</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="number" class="form-control" id="benefice_rapport" placeholder="" value="">
                                                <label for="floatingInput">Bénéfice</label>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="d-flex flex-wrap gap-2">
                                                    <label class="form-check-label" for="statut_dossier_rapport">ce dossier est-il terminé ?</label>
                                                    <input type="checkbox" name="statut_dossier_rapport" id="statut_dossier_rapport" switch="bool">
                                                    <label for="statut_dossier_rapport" data-on-label="Oui" data-off-label="Non" class="mb-0"></label>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <label class="form-check-label" for="statut_facture_rapport">Facture transmise ?</label>
                                                    <input type="checkbox" name="statut_facture_rapport" id="statut_facture_rapport" switch="bool">
                                                    <label for="statut_facture_rapport" data-on-label="Oui" data-off-label="Non" class="mb-0"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="date" class="form-control" id="date_transmission_facture_rapport" placeholder="" value="">
                                                <label for="floatingInput">Date Transmission Facture</label>
                                            </div>
                                            <div class="form-floating mb-3 col-md-2">
                                                <input type="date" class="form-control" id="date_cloture_dossier_rapport" placeholder="" value="">
                                                <label for="floatingInput">Date Clôture Dossier</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Veuillez saisir vos commentaires ici" id="observation_rapport" style="height: 100px"></textarea>
                                        ...
                                        <div class="row">
                                            <div class="mt-4">
                                                <button type="submit" id="send_report" class="btn btn-success w-md">Envoyer mon rapport</button>
                                                <button type="button" id="annul" class="btn btn-danger w-md">Annuler</button>
                                            </div>
                                        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-list"></i> Choisir une affectation</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
			                    ...
			                    <div class="row">
                                    <div class="col-md-4">
                                        <a href="ajouter_rapport_import.php">
                                        <div class="card mt-4 maintenance-box shadow-none">
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    <i class="uil uil-arrow-down-left h1 text-primary"></i>
                                                </div>
                                                
                                                <h5 class="font-size-15 text-uppercase">GESTION DES IMPORTATIONS</h5>
                                                <p class="text-muted mb-0">Concerne exclusivement le service Import.</p>
                                            </div>
                                        </div>
                                        </a>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-md-4">
                                        <a href="ajouter_rapport_export.php">
                                        <div class="card mt-4 maintenance-box shadow-none">
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    <i class="uil uil-share h1 text-primary"></i>
                                                </div>
                                                
                                                <h5 class="font-size-15 text-uppercase">GESTION DES EXPORTATIONS</h5>
                                                <p class="text-muted mb-0">Concerne exclusivement le service Export.</p>
                                            </div>
                                        </div>
                                        </a>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-md-4">
                                        <a href="ajouter_rapport_autre.php">
                                        <div class="card mt-4 maintenance-box shadow-none">
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    <i class="uil uil-clipboard-notes h1 text-primary"></i>
                                                </div>
                                                
                                                <h5 class="font-size-15 text-uppercase">AUTRE RAPPORT (Saisie libre)</h5>
                                                <p class="text-muted mb-0">Concerne tous les autres services.
                                                </p>
                                            </div>
                                        </div>
                                        </a>
