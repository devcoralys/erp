                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <button id="ajout_declaration" data-toggle="modal" data-target="#myModal_declaration" style="margin:10px; " class="btn btn-primary"><i class="fa fa-file-text"></i> Faire le rapport du jour</button>
                            </div>
    ...
    <a href="excel/excel_declaration.php" target="_blank" title="Exporter en Excel" id="title">
        <i class="fa fa-file-excel fa-2x" style="color:green;"></i>
                        ...
                        <div class="page-content-wrap"  style="">
                            ...
                            <div class="row voir aff_rapport">
      ...
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
			                    ...
			                    <div class="row">
			                        ...
			                        <?php if($_SESSION['acces_rapport_import']==1){ ?>
                                    <div class="col-md-4">
                                    ...
                                    <!-- end col -->
                                    <?php if($_SESSION['acces_rapport_export']==1){ ?>
                                    <div class="col-md-4">
                                    ...
                                    <!-- end col -->
                                    <?php if($_SESSION['acces_rapport_autre']==1){ ?>
                                    <div class="col-md-4">
