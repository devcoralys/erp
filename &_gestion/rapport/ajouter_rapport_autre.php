                          ...
                          <div class="col-xl-9">
                                <div class="card">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        <h4 class="card-title">Veuillez rediger votre rapport SVP</h4>
                                    </div><!-- end card header -->
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Veuillez saisir vos commentaires ici" id="floatingTextarea2" style="height: 100px"></textarea>
                                                <label for="floatingTextarea2">Rapport journalier...</label>
                                            </div>
                                            -->
                                            <textarea class="form-control" style="height:300px;" id="observation_rapport"></textarea>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="mt-4">
                                                <button type="submit" id="send_report_autre" class="btn btn-success w-md">Soumettre</button>
                                                <button type="submit" class="btn btn-danger w-md">Annuler</button>
                                            </div>
                                        </div>
